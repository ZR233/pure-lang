...
## [4.0.0](https://github.com/ZR233/pure-lang/compare/v3.0.0...v4.0.0) (2026-09-14)
...
* **agent-runtime:** 移除旧等待工具和 processId/yieldTimeMs 轮询协议，工具及事件源在会话创建时注册，跨 Turn 操作使用 taskId。
* **core:** 会话使用独立 sessions.sqlite；旧会话不迁移，项目和配置保留。ThreadRepository 新增 flush/shutdown 生命周期契约。
...
* **studio:** 按思考强度拆分 token 速度统计 ([#61](https://github.com/ZR233/pure-lang/issues/61)) ([cea925b](https://github.com/ZR233/pure-lang/commit/cea925bdbbab004183e052ec000bf04a69da9189))
...
* **agent-runtime:** 限制 actor 轮询栈并统一 Turn 启动边界 ([09d4284](https://github.com/ZR233/pure-lang/commit/09d428442db1177dd80690953309dd7e7b148d11))
...
* **studio:** 修复 Windows worktree 恢复路径 ([#60](https://github.com/ZR233/pure-lang/issues/60)) ([748dc8c](https://github.com/ZR233/pure-lang/commit/748dc8c047f112757dc1bb7e50d1ffbb69994a43))
...
* **studio:** 校验远程项目 canonical 采用状态 ([1ca7d0f](https://github.com/ZR233/pure-lang/commit/1ca7d0f8c289eef1bb3fed2dce1d0112dedd5a58))
...
* **agent-runtime:** 统一会话工具任务与唤醒 ([56b0b32](https://github.com/ZR233/pure-lang/commit/56b0b32619f505e713e44665c588adb179639951))
* **core:** 统一动态会话条目与独立异步持久化 ([58453ab](https://github.com/ZR233/pure-lang/commit/58453ab10d33d42967ce3a2fb290899f697a9b21))
...
* **studio:** 统一界面与组件并完善时间线结果展示 ([267ab40](https://github.com/ZR233/pure-lang/commit/267ab4006a5766c3cefbe6dbffbc6c3ba7e791f9))
...
* 同步会话工具运行时与宿主入口说明 ([fd387ea](https://github.com/ZR233/pure-lang/commit/fd387eadfd1be8282cf6482cfdc514d5f2c03fd3))
