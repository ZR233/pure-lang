...
mixin _$AgentWorkspaceView {
 ...
 StudioThread get thread; StudioThread get rootThread; AgentWorkspaceSyncState get syncState; List<TimelineRow> get timelineRows; TimelineTodoListUpdate? get todo; ThreadRuntimeView get runtime; StudioTurnView? get turn; StudioTurnView? get lastTurn; PendingInteraction? get activeInteraction; ComposerThreadState get composer; AgentComposerMode get composerMode; PermissionMode get permissionMode; List<ProviderSettingsView> get providers; List<RoleSettingsView> get roles; List<StudioAgentView> get agents;
...
@useResult
$Res call({
 StudioThread thread, StudioThread rootThread, AgentWorkspaceSyncState syncState, List<TimelineRow> timelineRows, TimelineTodoListUpdate? todo, ThreadRuntimeView runtime, StudioTurnView? turn, StudioTurnView? lastTurn, PendingInteraction? activeInteraction, ComposerThreadState composer, AgentComposerMode composerMode, PermissionMode permissionMode, List<ProviderSettingsView> providers, List<RoleSettingsView> roles, List<StudioAgentView> agents
});
...
/// Create a copy of AgentWorkspaceView
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? thread = null,Object? rootThread = null,Object? syncState = null,Object? timelineRows = null,Object? todo = freezed,Object? runtime = null,Object? turn = freezed,Object? lastTurn = freezed,Object? activeInteraction = freezed,Object? composer = null,Object? composerMode = null,Object? permissionMode = null,Object? providers = null,Object? roles = null,Object? agents = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( StudioThread thread,  StudioThread rootThread,  AgentWorkspaceSyncState syncState,  List<TimelineRow> timelineRows,  TimelineTodoListUpdate? todo,  ThreadRuntimeView runtime,  StudioTurnView? turn,  StudioTurnView? lastTurn,  PendingInteraction? activeInteraction,  ComposerThreadState composer,  AgentComposerMode composerMode,  PermissionMode permissionMode,  List<ProviderSettingsView> providers,  List<RoleSettingsView> roles,  List<StudioAgentView> agents)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AgentWorkspaceView() when $default != null:
return $default(_that.thread,_that.rootThread,_that.syncState,_that.timelineRows,_that.todo,_that.runtime,_that.turn,_that.lastTurn,_that.activeInteraction,_that.composer,_that.composerMode,_that.permissionMode,_that.providers,_that.roles,_that.agents);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( StudioThread thread,  StudioThread rootThread,  AgentWorkspaceSyncState syncState,  List<TimelineRow> timelineRows,  TimelineTodoListUpdate? todo,  ThreadRuntimeView runtime,  StudioTurnView? turn,  StudioTurnView? lastTurn,  PendingInteraction? activeInteraction,  ComposerThreadState composer,  AgentComposerMode composerMode,  PermissionMode permissionMode,  List<ProviderSettingsView> providers,  List<RoleSettingsView> roles,  List<StudioAgentView> agents)  $default,) {final _that = this;
switch (_that) {
case _AgentWorkspaceView():
return $default(_that.thread,_that.rootThread,_that.syncState,_that.timelineRows,_that.todo,_that.runtime,_that.turn,_that.lastTurn,_that.activeInteraction,_that.composer,_that.composerMode,_that.permissionMode,_that.providers,_that.roles,_that.agents);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( StudioThread thread,  StudioThread rootThread,  AgentWorkspaceSyncState syncState,  List<TimelineRow> timelineRows,  TimelineTodoListUpdate? todo,  ThreadRuntimeView runtime,  StudioTurnView? turn,  StudioTurnView? lastTurn,  PendingInteraction? activeInteraction,  ComposerThreadState composer,  AgentComposerMode composerMode,  PermissionMode permissionMode,  List<ProviderSettingsView> providers,  List<RoleSettingsView> roles,  List<StudioAgentView> agents)?  $default,) {final _that = this;
switch (_that) {
case _AgentWorkspaceView() when $default != null:
return $default(_that.thread,_that.rootThread,_that.syncState,_that.timelineRows,_that.todo,_that.runtime,_that.turn,_that.lastTurn,_that.activeInteraction,_that.composer,_that.composerMode,_that.permissionMode,_that.providers,_that.roles,_that.agents);case _:
  return null;
...
class _AgentWorkspaceView extends AgentWorkspaceView {
  const _AgentWorkspaceView({required this.thread, required this.rootThread, required this.syncState, required  List<TimelineRow> timelineRows, required this.todo, required this.runtime, required this.turn, this.lastTurn, required this.activeInteraction, required this.composer, required this.composerMode, required this.permissionMode, required  List<ProviderSettingsView> providers, required  List<RoleSettingsView> roles, required  List<StudioAgentView> agents}): _timelineRows = timelineRows,_providers = providers,_roles = roles,_agents = agents,super._();
...
@override
int get hashCode {
    return Object.hash(runtimeType,thread,rootThread,syncState,const DeepCollectionEquality().hash(_timelineRows),todo,runtime,turn,lastTurn,activeInteraction,composer,composerMode,permissionMode,const DeepCollectionEquality().hash(_providers),const DeepCollectionEquality().hash(_roles),const DeepCollectionEquality().hash(_agents));
}

@override
String toString() {
    return 'AgentWorkspaceView(thread: $thread, rootThread: $rootThread, syncState: $syncState, timelineRows: $timelineRows, todo: $todo, runtime: $runtime, turn: $turn, lastTurn: $lastTurn, activeInteraction: $activeInteraction, composer: $composer, composerMode: $composerMode, permissionMode: $permissionMode, providers: $providers, roles: $roles, agents: $agents)';
}
...
/// Create a copy of AgentWorkspaceView
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? thread = null,Object? rootThread = null,Object? syncState = null,Object? timelineRows = null,Object? todo = freezed,Object? runtime = null,Object? turn = freezed,Object? lastTurn = freezed,Object? activeInteraction = freezed,Object? composer = null,Object? composerMode = null,Object? permissionMode = null,Object? providers = null,Object? roles = null,Object? agents = null,}) {
