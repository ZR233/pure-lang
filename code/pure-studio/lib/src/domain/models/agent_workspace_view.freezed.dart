...
mixin _$AgentWorkspaceView {
 ...
 StudioSession get session; StudioSession get rootSession; AgentWorkspaceSyncState get syncState; List<TimelineRow> get timelineRows; TimelineTodoListUpdate? get todo; SessionRuntimeView get runtime; TurnPhase get turnPhase; PendingInteraction? get activeInteraction; String get composerText; AgentComposerMode get composerMode; PermissionMode get permissionMode; List<ProviderSettingsView> get providers; List<RoleSettingsView> get roles; List<StudioAgentView> get agents;
...
@override
int get hashCode => Object.hash(runtimeType,session,rootSession,syncState,const DeepCollectionEquality().hash(timelineRows),todo,runtime,turnPhase,activeInteraction,composerText,composerMode,permissionMode,const DeepCollectionEquality().hash(providers),const DeepCollectionEquality().hash(roles),const DeepCollectionEquality().hash(agents));

@override
String toString() {
  return 'AgentWorkspaceView(session: $session, rootSession: $rootSession, syncState: $syncState, timelineRows: $timelineRows, todo: $todo, runtime: $runtime, turnPhase: $turnPhase, activeInteraction: $activeInteraction, composerText: $composerText, composerMode: $composerMode, permissionMode: $permissionMode, providers: $providers, roles: $roles, agents: $agents)';
}
...
@useResult
$Res call({
 StudioSession session, StudioSession rootSession, AgentWorkspaceSyncState syncState, List<TimelineRow> timelineRows, TimelineTodoListUpdate? todo, SessionRuntimeView runtime, TurnPhase turnPhase, PendingInteraction? activeInteraction, String composerText, AgentComposerMode composerMode, PermissionMode permissionMode, List<ProviderSettingsView> providers, List<RoleSettingsView> roles, List<StudioAgentView> agents
});
...
/// Create a copy of AgentWorkspaceView
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? session = null,Object? rootSession = null,Object? syncState = null,Object? timelineRows = null,Object? todo = freezed,Object? runtime = null,Object? turnPhase = null,Object? activeInteraction = freezed,Object? composerText = null,Object? composerMode = null,Object? permissionMode = null,Object? providers = null,Object? roles = null,Object? agents = null,}) {
...
as SessionRuntimeView,turnPhase: null == turnPhase ? _self.turnPhase : turnPhase // ignore: cast_nullable_to_non_nullable
as TurnPhase,activeInteraction: freezed == activeInteraction ? _self.activeInteraction : activeInteraction // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _AgentWorkspaceView() when $default != null:
return $default(_that.session,_that.rootSession,_that.syncState,_that.timelineRows,_that.todo,_that.runtime,_that.turnPhase,_that.activeInteraction,_that.composerText,_that.composerMode,_that.permissionMode,_that.providers,_that.roles,_that.agents);case _:
  return orElse();
...
class _AgentWorkspaceView extends AgentWorkspaceView {
  const _AgentWorkspaceView({required this.session, required this.rootSession, required this.syncState, required final  List<TimelineRow> timelineRows, required this.todo, required this.runtime, required this.turnPhase, required this.activeInteraction, required this.composerText, required this.composerMode, required this.permissionMode, required final  List<ProviderSettingsView> providers, required final  List<RoleSettingsView> roles, required final  List<StudioAgentView> agents}): _timelineRows = timelineRows,_providers = providers,_roles = roles,_agents = agents,super._();
...
@override final  TurnPhase turnPhase;
...
@override
int get hashCode => Object.hash(runtimeType,session,rootSession,syncState,const DeepCollectionEquality().hash(_timelineRows),todo,runtime,turnPhase,activeInteraction,composerText,composerMode,permissionMode,const DeepCollectionEquality().hash(_providers),const DeepCollectionEquality().hash(_roles),const DeepCollectionEquality().hash(_agents));
