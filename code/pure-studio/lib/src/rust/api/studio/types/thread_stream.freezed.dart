...
class BridgeTurnCancellationCause_Unspecified extends BridgeTurnCancellationCause {
  const BridgeTurnCancellationCause_Unspecified(): super._();
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is BridgeTurnCancellationCause_Unspecified);
}
...
@override
String toString() {
    return 'BridgeTurnCancellationCause.unspecified()';
}
