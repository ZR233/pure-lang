const zhCN = {
  ...
  status: {
    ...
    instructionsSettingsSaved: "提示词设置已保存",
    ...
    instructionsSettingsInvalid: "提示词设置无效：{{error}}",
  ...
  settings: {
    ...
    instructions: {
      title: "提示词分层",
      description: "配置新会话会锁定的 base、developer 和 user context。已有会话继续使用自己的快照。",
      baseOverride: "Base override",
      baseOverrideDesc: "完整替换模型基础系统提示词；普通协作偏好应写入 developer 或 user context。",
      developer: "Developer",
      developerDesc: "本地运行约束、协作规则和稳定行为偏好。",
      user: "User context",
      userDesc: "用户背景、项目上下文和非强制偏好。",
      projectDocMaxBytes: "项目文档字节上限",
      fallbackFilenames: "Fallback 文件名",
      fallbackFilenamesDesc: "逗号分隔；会在 AGENTS.override.md、AGENTS.md、Agents.md 后尝试。",
    },
    security: {
      title: "权限模式",
  ...
  provider: {
    ...
    refreshProviderUsageTooltip: "查询此供应商额度",
    usage: "剩余用量",
    ...
    balanceGranted: "赠送",
    balanceToppedUp: "充值",
    usageUpdatedAt: "{{time}} 更新",
    remainingPercent: "剩余 {{percent}}",
    remainingOfTotal: "剩 {{remaining}} / {{total}}",
    usedOfTotal: "已用 {{current}} / {{total}}",
    usedValue: "已用 {{value}}",
    quotaFiveHour: "5 小时",
    quotaWeekly: "7 天",
    quotaMcp: "MCP 工具",
