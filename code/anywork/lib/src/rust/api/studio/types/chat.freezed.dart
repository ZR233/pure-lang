...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( BridgeChatSnapshot snapshot)?  reset,TResult Function( BigInt from,  BigInt to,  List<BridgeViewChange> changes,  bool hasNewer)?  patch,required TResult orElse(),}) {final _that = this;
switch (_that) {
case BridgeChatUpdate_Reset() when reset != null:
return reset(_that.snapshot);case BridgeChatUpdate_Patch() when patch != null:
return patch(_that.from,_that.to,_that.changes,_that.hasNewer);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( BridgeChatSnapshot snapshot)  reset,required TResult Function( BigInt from,  BigInt to,  List<BridgeViewChange> changes,  bool hasNewer)  patch,}) {final _that = this;
switch (_that) {
case BridgeChatUpdate_Reset():
return reset(_that.snapshot);case BridgeChatUpdate_Patch():
return patch(_that.from,_that.to,_that.changes,_that.hasNewer);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( BridgeChatSnapshot snapshot)?  reset,TResult? Function( BigInt from,  BigInt to,  List<BridgeViewChange> changes,  bool hasNewer)?  patch,}) {final _that = this;
switch (_that) {
case BridgeChatUpdate_Reset() when reset != null:
return reset(_that.snapshot);case BridgeChatUpdate_Patch() when patch != null:
return patch(_that.from,_that.to,_that.changes,_that.hasNewer);case _:
...
class BridgeChatUpdate_Patch extends BridgeChatUpdate {
  const BridgeChatUpdate_Patch({required this.from, required this.to, required  List<BridgeViewChange> changes, required this.hasNewer}): _changes = changes,super._();
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is BridgeChatUpdate_Patch&&(identical(other.from, from) || other.from == from)&&(identical(other.to, to) || other.to == to)&&const DeepCollectionEquality().equals(other.changes, _changes)&&(identical(other.hasNewer, hasNewer) || other.hasNewer == hasNewer));
}


@override
int get hashCode {
    return Object.hash(runtimeType,from,to,const DeepCollectionEquality().hash(_changes),hasNewer);
}

@override
String toString() {
    return 'BridgeChatUpdate.patch(from: $from, to: $to, changes: $changes, hasNewer: $hasNewer)';
}
...
@useResult
$Res call({
 BigInt from, BigInt to, List<BridgeViewChange> changes, bool hasNewer
});
...
/// Create a copy of BridgeChatUpdate
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? from = null,Object? to = null,Object? changes = null,Object? hasNewer = null,}) {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( BridgeViewChange_Splice value)?  splice,TResult Function( BridgeViewChange_AppendText value)?  appendText,required TResult orElse(),}){
final _that = this;
switch (_that) {
case BridgeViewChange_Splice() when splice != null:
return splice(_that);case BridgeViewChange_AppendText() when appendText != null:
return appendText(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( BridgeViewChange_Splice value)  splice,required TResult Function( BridgeViewChange_AppendText value)  appendText,}){
final _that = this;
switch (_that) {
case BridgeViewChange_Splice():
return splice(_that);case BridgeViewChange_AppendText():
return appendText(_that);}
}
/// A variant of `map` that fallback to returning `null`.
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( BridgeViewChange_Splice value)?  splice,TResult? Function( BridgeViewChange_AppendText value)?  appendText,}){
final _that = this;
switch (_that) {
case BridgeViewChange_Splice() when splice != null:
return splice(_that);case BridgeViewChange_AppendText() when appendText != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( BigInt index,  BigInt remove,  List<BridgeChatItem> items)?  splice,TResult Function( String itemId,  String partId,  BigInt expectedRevision,  BigInt revision,  String text)?  appendText,required TResult orElse(),}) {final _that = this;
switch (_that) {
case BridgeViewChange_Splice() when splice != null:
return splice(_that.index,_that.remove,_that.items);case BridgeViewChange_AppendText() when appendText != null:
return appendText(_that.itemId,_that.partId,_that.expectedRevision,_that.revision,_that.text);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( BigInt index,  BigInt remove,  List<BridgeChatItem> items)  splice,required TResult Function( String itemId,  String partId,  BigInt expectedRevision,  BigInt revision,  String text)  appendText,}) {final _that = this;
switch (_that) {
case BridgeViewChange_Splice():
return splice(_that.index,_that.remove,_that.items);case BridgeViewChange_AppendText():
return appendText(_that.itemId,_that.partId,_that.expectedRevision,_that.revision,_that.text);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( BigInt index,  BigInt remove,  List<BridgeChatItem> items)?  splice,TResult? Function( String itemId,  String partId,  BigInt expectedRevision,  BigInt revision,  String text)?  appendText,}) {final _that = this;
switch (_that) {
case BridgeViewChange_Splice() when splice != null:
return splice(_that.index,_that.remove,_that.items);case BridgeViewChange_AppendText() when appendText != null:
return appendText(_that.itemId,_that.partId,_that.expectedRevision,_that.revision,_that.text);case _:
...
class BridgeViewChange_AppendText extends BridgeViewChange {
  const BridgeViewChange_AppendText({required this.itemId, required this.partId, required this.expectedRevision, required this.revision, required this.text}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$BridgeViewChange_AppendTextCopyWith<BridgeViewChange_AppendText> get copyWith => _$BridgeViewChange_AppendTextCopyWithImpl<BridgeViewChange_AppendText>(this, _$identity);



@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is BridgeViewChange_AppendText&&(identical(other.itemId, itemId) || other.itemId == itemId)&&(identical(other.partId, partId) || other.partId == partId)&&(identical(other.expectedRevision, expectedRevision) || other.expectedRevision == expectedRevision)&&(identical(other.revision, revision) || other.revision == revision)&&(identical(other.text, text) || other.text == text));
}


@override
int get hashCode {
    return Object.hash(runtimeType,itemId,partId,expectedRevision,revision,text);
}

@override
String toString() {
    return 'BridgeViewChange.appendText(itemId: $itemId, partId: $partId, expectedRevision: $expectedRevision, revision: $revision, text: $text)';
}
...
/// @nodoc
abstract mixin class $BridgeViewChange_AppendTextCopyWith<$Res> implements $BridgeViewChangeCopyWith<$Res> {
  factory $BridgeViewChange_AppendTextCopyWith(BridgeViewChange_AppendText value, $Res Function(BridgeViewChange_AppendText) _then) = _$BridgeViewChange_AppendTextCopyWithImpl;
@useResult
$Res call({
 String itemId, String partId, BigInt expectedRevision, BigInt revision, String text
});
...
/// @nodoc
class _$BridgeViewChange_AppendTextCopyWithImpl<$Res>
    implements $BridgeViewChange_AppendTextCopyWith<$Res> {
  _$BridgeViewChange_AppendTextCopyWithImpl(this._self, this._then);

  final BridgeViewChange_AppendText _self;
  final $Res Function(BridgeViewChange_AppendText) _then;

/// Create a copy of BridgeViewChange
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? itemId = null,Object? partId = null,Object? expectedRevision = null,Object? revision = null,Object? text = null,}) {
  return _then(BridgeViewChange_AppendText(
itemId: null == itemId ? _self.itemId : itemId // ignore: cast_nullable_to_non_nullable
