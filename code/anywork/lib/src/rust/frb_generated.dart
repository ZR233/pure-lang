...
abstract class RustLibApi extends BaseApi {
  Future<void> crateApiStudioHandlersChatBridgeChatViewClose({
  ...
  Future<BridgeChatSnapshot> crateApiStudioHandlersChatBridgeChatViewInitial({
    required BridgeChatView that,
  });

  Future<BridgeChatSnapshot> crateApiStudioHandlersChatBridgeChatViewLoad({
    required BridgeChatView that,
    required BridgeChatDirection direction,
  });

  Future<BridgeChatUpdate?> crateApiStudioHandlersChatBridgeChatViewNext({
    required BridgeChatView that,
  });

  Future<BridgeChatItem?> crateApiStudioHandlersChatBridgeChatViewReadItem({
    required BridgeChatView that,
    required String itemId,
  });

  Future<BridgeChatSnapshot> crateApiStudioHandlersChatBridgeChatViewSnapshot({
    required BridgeChatView that,
  });
  ...
  Future<BridgeTimelinePage> crateApiStudioHandlersHistoryListTimelineItems({
  ...
  Future<BridgeChatView> crateApiStudioHandlersChatOpenChatView({
    required String threadId,
    required BridgeChatFocus focus,
  });
  ...
  Future<BridgeThreadDirectoryPage> crateApiStudioHandlersHistoryQueryThreads({
  ...
  Future<BridgeDeepSeekWebSearchSettingsDto>
  ...
  Future<BridgeThreadActivityDetail>
  crateApiStudioHandlersHistoryReadThreadActivityDetail({
    required String threadId,
  ...
  Future<BridgeTimelinePage> crateApiStudioHandlersHistoryReadTimelineItem({
    required String threadId,
    required String itemId,
  });
  ...
  Future<BridgeThread> crateApiStudioHandlersThreadRenameThread({
    required String threadId,
  ...
  Future<BridgeThread> crateApiStudioHandlersThreadRestoreThread({
    required String threadId,
  });

  Future<BridgePersistenceQueueSnapshot>
  crateApiStudioHandlersPersistenceResumeThreadHistory({
    required String threadId,
    required BigInt faultGeneration,
  });

  Future<BridgePersistenceStateSnapshot>
  crateApiStudioHandlersPersistenceRetryPersistence();

  Future<BridgeRecoveryStateSnapshot>
  crateApiStudioHandlersLifecycleRetryRecovery();

  Future<BridgePersistenceQueueSnapshot>
  crateApiStudioHandlersPersistenceRetryThreadHistory({
    required String threadId,
    required BigInt faultGeneration,
  });
  ...
  get rust_arc_increment_strong_count_BridgeChatView;

  RustArcDecrementStrongCountFnType
  get rust_arc_decrement_strong_count_BridgeChatView;

  CrossPlatformFinalizerArg
  get rust_arc_decrement_strong_count_BridgeChatViewPtr;
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<void> crateApiStudioHandlersChatBridgeChatViewClose({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiStudioHandlersChatBridgeChatViewCloseConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiStudioHandlersChatBridgeChatViewCloseConstMeta =>
      const TaskConstMeta(
        debugName: "BridgeChatView_close",
        argNames: ["that"],
      );
  ...
  Future<BridgeChatSnapshot> crateApiStudioHandlersChatBridgeChatViewExpand({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiStudioHandlersChatBridgeChatViewExpandConstMeta,
  ...
  TaskConstMeta get kCrateApiStudioHandlersChatBridgeChatViewExpandConstMeta =>
      const TaskConstMeta(
        debugName: "BridgeChatView_expand",
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_box_autoadd_bridge_chat_focus(focus, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 3,
        ...
        constMeta: kCrateApiStudioHandlersChatBridgeChatViewFocusConstMeta,
        argValues: [that, focus],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiStudioHandlersChatBridgeChatViewFocusConstMeta =>
      const TaskConstMeta(
        debugName: "BridgeChatView_focus",
        argNames: ["that", "focus"],
      );
  ...
  Future<BridgeChatSnapshot> crateApiStudioHandlersChatBridgeChatViewInitial({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiStudioHandlersChatBridgeChatViewInitialConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiStudioHandlersChatBridgeChatViewInitialConstMeta =>
      const TaskConstMeta(
        debugName: "BridgeChatView_initial",
        argNames: ["that"],
      );
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_bridge_chat_direction(direction, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 5,
        ...
        constMeta: kCrateApiStudioHandlersChatBridgeChatViewLoadConstMeta,
  ...
  TaskConstMeta get kCrateApiStudioHandlersChatBridgeChatViewLoadConstMeta =>
      const TaskConstMeta(
        debugName: "BridgeChatView_load",
  ...
  Future<BridgeChatUpdate?> crateApiStudioHandlersChatBridgeChatViewNext({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_opt_box_autoadd_bridge_chat_update,
          decodeErrorData: sse_decode_bridge_error,
        ),
        constMeta: kCrateApiStudioHandlersChatBridgeChatViewNextConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiStudioHandlersChatBridgeChatViewNextConstMeta =>
      const TaskConstMeta(debugName: "BridgeChatView_next", argNames: ["that"]);
  ...
  Future<BridgeChatItem?> crateApiStudioHandlersChatBridgeChatViewReadItem({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_opt_box_autoadd_bridge_chat_item,
          decodeErrorData: sse_decode_bridge_error,
        ),
        constMeta: kCrateApiStudioHandlersChatBridgeChatViewReadItemConstMeta,
        argValues: [that, itemId],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiStudioHandlersChatBridgeChatViewReadItemConstMeta =>
      const TaskConstMeta(
        debugName: "BridgeChatView_read_item",
        argNames: ["that", "itemId"],
      );
  ...
  Future<BridgeChatSnapshot> crateApiStudioHandlersChatBridgeChatViewSnapshot({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiStudioHandlersChatBridgeChatViewSnapshotConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiStudioHandlersChatBridgeChatViewSnapshotConstMeta =>
      const TaskConstMeta(
        debugName: "BridgeChatView_snapshot",
        argNames: ["that"],
      );
    ...
    unawaited(
      handler.executeNormal(
        NormalTask(
          ...
          constMeta:
              kCrateApiStudioSubscriptionBridgeEventSubscriptionShutdownStreamConstMeta,
          argValues: [that, sink],
          apiImpl: this,
        ),
      ),
  ...
  TaskConstMeta
  get kCrateApiStudioSubscriptionBridgeEventSubscriptionShutdownStreamConstMeta =>
      const TaskConstMeta(
        debugName: "BridgeEventSubscription_shutdown_stream",
        argNames: ["that", "sink"],
      );
  ...
  crateApiStudioTypesThreadStreamBridgeCacheUsageSummaryDefault() {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_bridge_cache_usage_summary,
          decodeErrorData: null,
        ),
        constMeta:
            kCrateApiStudioTypesThreadStreamBridgeCacheUsageSummaryDefaultConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiStudioTypesThreadStreamBridgeCacheUsageSummaryDefaultConstMeta =>
      const TaskConstMeta(
        debugName: "bridge_cache_usage_summary_default",
        argNames: [],
      );
  ...
  crateApiStudioTypesThreadActivityBridgeThreadActivityToolsDefault() {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_bridge_thread_activity_tools,
          decodeErrorData: null,
        ),
        constMeta:
            kCrateApiStudioTypesThreadActivityBridgeThreadActivityToolsDefaultConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiStudioTypesThreadActivityBridgeThreadActivityToolsDefaultConstMeta =>
      const TaskConstMeta(
        debugName: "bridge_thread_activity_tools_default",
        argNames: [],
      );
  ...
  TaskConstMeta get kCrateApiStudioHandlersSshDeleteSshServerConstMeta =>
      const TaskConstMeta(debugName: "delete_ssh_server", argNames: ["alias"]);
  ...
  Future<BridgeTimelinePage> crateApiStudioHandlersHistoryListTimelineItems({
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_box_autoadd_list_timeline_items_request(
            request,
            serializer,
          );
          pdeCallFfi(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_bridge_timeline_page,
          decodeErrorData: sse_decode_bridge_error,
        ),
        constMeta: kCrateApiStudioHandlersHistoryListTimelineItemsConstMeta,
        argValues: [request],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiStudioHandlersHistoryListTimelineItemsConstMeta =>
      const TaskConstMeta(
        debugName: "list_timeline_items",
        argNames: ["request"],
      );
  ...
  Future<BridgeChatView> crateApiStudioHandlersChatOpenChatView({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiStudioHandlersChatOpenChatViewConstMeta,
        argValues: [threadId, focus],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiStudioHandlersChatOpenChatViewConstMeta =>
      const TaskConstMeta(
        debugName: "open_chat_view",
        argNames: ["threadId", "focus"],
      );
  ...
  Future<BridgeThreadDirectoryPage> crateApiStudioHandlersHistoryQueryThreads({
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_box_autoadd_bridge_directory_query(request, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 45,
        ...
        constMeta: kCrateApiStudioHandlersHistoryQueryThreadsConstMeta,
        argValues: [request],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiStudioHandlersHistoryQueryThreadsConstMeta =>
  ...
  crateApiStudioHandlersSettingsReadDeepseekWebSearchSettings() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiStudioHandlersSettingsReadDeepseekWebSearchSettingsConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiStudioHandlersSettingsReadDeepseekWebSearchSettingsConstMeta =>
      const TaskConstMeta(
        debugName: "read_deepseek_web_search_settings",
        argNames: [],
      );
  ...
  crateApiStudioHandlersPersistenceReadPersistenceQueue() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiStudioHandlersPersistenceReadPersistenceQueueConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiStudioHandlersPersistenceReadPersistenceQueueConstMeta =>
      const TaskConstMeta(debugName: "read_persistence_queue", argNames: []);
  ...
  crateApiStudioHandlersLifecycleReadRecoveryState() {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_bridge_recovery_state_snapshot,
          decodeErrorData: sse_decode_bridge_error,
        ),
        constMeta: kCrateApiStudioHandlersLifecycleReadRecoveryStateConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiStudioHandlersLifecycleReadRecoveryStateConstMeta =>
  ...
  crateApiStudioHandlersHistoryReadThreadActivityDetail({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_bridge_thread_activity_detail,
          decodeErrorData: sse_decode_bridge_error,
        ),
        constMeta:
            kCrateApiStudioHandlersHistoryReadThreadActivityDetailConstMeta,
        argValues: [threadId, activityId],
        apiImpl: this,
      ),
    );
  }
  ...
  TaskConstMeta
  get kCrateApiStudioHandlersHistoryReadThreadActivityDetailConstMeta =>
      const TaskConstMeta(
        debugName: "read_thread_activity_detail",
        argNames: ["threadId", "activityId"],
      );
  ...
  Future<BridgeTimelinePage> crateApiStudioHandlersHistoryReadTimelineItem({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiStudioHandlersHistoryReadTimelineItemConstMeta,
        argValues: [threadId, itemId],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiStudioHandlersHistoryReadTimelineItemConstMeta =>
      const TaskConstMeta(
        debugName: "read_timeline_item",
        argNames: ["threadId", "itemId"],
      );
  ...
  Future<ProjectDto> crateApiStudioHandlersLifecycleRenameProject({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiStudioHandlersLifecycleRenameProjectConstMeta,
  ...
  TaskConstMeta get kCrateApiStudioHandlersLifecycleRenameProjectConstMeta =>
      const TaskConstMeta(
  ...
  Future<BridgeThread> crateApiStudioHandlersThreadRenameThread({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiStudioHandlersThreadRenameThreadConstMeta,
        argValues: [threadId, title],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiStudioHandlersThreadRenameThreadConstMeta =>
      const TaskConstMeta(
        debugName: "rename_thread",
        argNames: ["threadId", "title"],
      );
  ...
  Future<BridgeThread> crateApiStudioHandlersThreadRestoreThread({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiStudioHandlersThreadRestoreThreadConstMeta,
        argValues: [threadId],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiStudioHandlersThreadRestoreThreadConstMeta =>
      const TaskConstMeta(debugName: "restore_thread", argNames: ["threadId"]);
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_String(threadId, serializer);
          sse_encode_u_64(faultGeneration, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 74,
        ...
        constMeta:
            kCrateApiStudioHandlersPersistenceResumeThreadHistoryConstMeta,
        argValues: [threadId, faultGeneration],
        apiImpl: this,
      ),
    );
  }
  ...
  TaskConstMeta
  get kCrateApiStudioHandlersPersistenceResumeThreadHistoryConstMeta =>
      const TaskConstMeta(
        debugName: "resume_thread_history",
        argNames: ["threadId", "faultGeneration"],
      );
  ...
  crateApiStudioHandlersPersistenceRetryPersistence() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiStudioHandlersPersistenceRetryPersistenceConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiStudioHandlersPersistenceRetryPersistenceConstMeta =>
  ...
  crateApiStudioHandlersLifecycleRetryRecovery() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiStudioHandlersLifecycleRetryRecoveryConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiStudioHandlersLifecycleRetryRecoveryConstMeta =>
      const TaskConstMeta(debugName: "retry_recovery", argNames: []);
  ...
  crateApiStudioHandlersPersistenceRetryThreadHistory({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiStudioHandlersPersistenceRetryThreadHistoryConstMeta,
        argValues: [threadId, faultGeneration],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiStudioHandlersPersistenceRetryThreadHistoryConstMeta =>
      const TaskConstMeta(
        debugName: "retry_thread_history",
        argNames: ["threadId", "faultGeneration"],
      );
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_String(whenToUse, serializer);
          sse_encode_String(systemInstructions, serializer);
  ...
  TaskConstMeta
  get kCrateApiStudioHandlersAgentProfilesSaveUserAgentProfileConstMeta =>
      const TaskConstMeta(
  ...
  Future<BridgeSkillSearchResult> crateApiStudioHandlersProvidersSearchSkills({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_bridge_skill_search_result,
          decodeErrorData: sse_decode_bridge_error,
        ),
        constMeta: kCrateApiStudioHandlersProvidersSearchSkillsConstMeta,
        argValues: [projectId, query, limit],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiStudioHandlersProvidersSearchSkillsConstMeta =>
      const TaskConstMeta(
        debugName: "search_skills",
        argNames: ["projectId", "query", "limit"],
      );
  ...
  RustArcIncrementStrongCountFnType
  get rust_arc_increment_strong_count_BridgeChatView => wire
      .rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBridgeChatView;

  RustArcDecrementStrongCountFnType
  get rust_arc_decrement_strong_count_BridgeChatView => wire
  ...
  dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBridgeChatView(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return BridgeChatViewImpl.frbInternalDcoDecode(raw as List<dynamic>);
  }
  ...
  BridgeDirectoryQuery dco_decode_box_autoadd_bridge_directory_query(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_bridge_directory_query(raw);
  }
  ...
  @protected
  BridgeHistoryFault dco_decode_box_autoadd_bridge_history_fault(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_bridge_history_fault(raw);
  }
  ...
  @protected
  BridgeThreadActivity dco_decode_box_autoadd_bridge_thread_activity(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_bridge_thread_activity(raw);
  }

  @protected
  BridgeThreadActivityToolEntry
  dco_decode_box_autoadd_bridge_thread_activity_tool_entry(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_bridge_thread_activity_tool_entry(raw);
  }
  ...
  @protected
  BridgeThreadStorageState dco_decode_box_autoadd_bridge_thread_storage_state(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_bridge_thread_storage_state(raw);
  }
  ...
  BridgeWorkflowRun dco_decode_box_autoadd_bridge_workflow_run(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_bridge_workflow_run(raw);
  }
  ...
  dco_decode_box_autoadd_bridge_workflow_runtime_snapshot(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_bridge_workflow_runtime_snapshot(raw);
  }
  ...
  ListTimelineItemsRequest dco_decode_box_autoadd_list_timeline_items_request(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_list_timeline_items_request(raw);
  }
  ...
  @protected
  BridgeThreadStorageState dco_decode_box_bridge_thread_storage_state(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_bridge_thread_storage_state(raw);
  ...
  BridgeAgentProfileDto dco_decode_bridge_agent_profile_dto(dynamic raw) {
    ...
    return BridgeAgentProfileDto(
      ...
      whenToUse: dco_decode_String(arr[3]),
      systemInstructions: dco_decode_String(arr[4]),
      providerId: dco_decode_String(arr[5]),
      model: dco_decode_String(arr[6]),
      effort: dco_decode_opt_String(arr[7]),
      source: dco_decode_String(arr[8]),
      revision: dco_decode_String(arr[9]),
  ...
  BridgeCacheUsageSummary dco_decode_bridge_cache_usage_summary(dynamic raw) {
    ...
    return BridgeCacheUsageSummary(
      inputTokens: dco_decode_u_64(arr[0]),
      cacheReadTokens: dco_decode_u_64(arr[1]),
      hitRate: dco_decode_opt_box_autoadd_f_64(arr[2]),
      hasIncompleteUsage: dco_decode_bool(arr[3]),
    );
  }
  ...
  BridgeChatDirection dco_decode_bridge_chat_direction(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return BridgeChatDirection.values[raw as int];
  }
  ...
  BridgeChatFocus dco_decode_bridge_chat_focus(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return BridgeChatFocus_Latest();
      case 1:
        return BridgeChatFocus_Around(itemId: dco_decode_String(raw[1]));
      default:
        throw Exception("unreachable");
    }
  }
  ...
  BridgeChatItem dco_decode_bridge_chat_item(dynamic raw) {
    ...
    if (arr.length != 4)
      throw Exception('unexpected arr length: expect 4 but see ${arr.length}');
    return BridgeChatItem(
      item: dco_decode_bridge_thread_item(arr[0]),
      saved: dco_decode_bool(arr[1]),
      lifecycle: dco_decode_bridge_chat_lifecycle(arr[2]),
      omittedBytes: dco_decode_u_64(arr[3]),
    );
  }

  @protected
  BridgeChatLifecycle dco_decode_bridge_chat_lifecycle(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return BridgeChatLifecycle.values[raw as int];
  }
  ...
  BridgeChatUpdate dco_decode_bridge_chat_update(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return BridgeChatUpdate_Reset(
          snapshot: dco_decode_box_autoadd_bridge_chat_snapshot(raw[1]),
        );
      case 1:
        return BridgeChatUpdate_Patch(
          from: dco_decode_u_64(raw[1]),
          to: dco_decode_u_64(raw[2]),
          changes: dco_decode_list_bridge_view_change(raw[3]),
          hasNewer: dco_decode_bool(raw[4]),
          priority: dco_decode_bridge_update_priority(raw[5]),
        );
      default:
        throw Exception("unreachable");
    }
  ...
  @protected
  BridgeContentField dco_decode_bridge_content_field(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    switch (raw[0]) {
      case 0:
        return BridgeContentField_Text();
      case 1:
        return BridgeContentField_ThinkingSummary(
          chunkIndex: dco_decode_u_32(raw[1]),
        );
      case 2:
        return BridgeContentField_ThinkingContent(
          chunkIndex: dco_decode_u_32(raw[1]),
        );
      case 3:
        return BridgeContentField_ToolArguments();
      case 4:
        return BridgeContentField_ToolResult();
      default:
        throw Exception("unreachable");
    }
  }
  ...
  BridgeDirectoryFilter dco_decode_bridge_directory_filter(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return BridgeDirectoryFilter.values[raw as int];
  }
  ...
  BridgeDirectoryQuery dco_decode_bridge_directory_query(dynamic raw) {
    ...
    if (arr.length != 6)
      throw Exception('unexpected arr length: expect 6 but see ${arr.length}');
    return BridgeDirectoryQuery(
      projectId: dco_decode_opt_String(arr[0]),
      search: dco_decode_opt_String(arr[1]),
      archived: dco_decode_bool(arr[2]),
      filter: dco_decode_bridge_directory_filter(arr[3]),
  ...
  @protected
  BridgeFieldChange dco_decode_bridge_field_change(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    switch (raw[0]) {
      case 0:
        return BridgeFieldChange_Unchanged();
      case 1:
        return BridgeFieldChange_Append(text: dco_decode_String(raw[1]));
      case 2:
        return BridgeFieldChange_Replace(text: dco_decode_String(raw[1]));
      case 3:
        return BridgeFieldChange_Remove();
      default:
        throw Exception("unreachable");
    }
  }
  ...
  @protected
  BridgeFieldUpdate dco_decode_bridge_field_update(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 2)
      throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
    return BridgeFieldUpdate(
      field: dco_decode_bridge_content_field(arr[0]),
      change: dco_decode_bridge_field_change(arr[1]),
    );
  }
  ...
  @protected
  BridgeHistoryFault dco_decode_bridge_history_fault(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return BridgeHistoryFault.values[raw as int];
  }
  ...
  BridgeModelPriceTier dco_decode_bridge_model_price_tier(dynamic raw) {
    ...
    if (arr.length != 5)
      throw Exception('unexpected arr length: expect 5 but see ${arr.length}');
    return BridgeModelPriceTier(
      label: dco_decode_String(arr[0]),
      inputPerMtok: dco_decode_f_64(arr[1]),
      outputPerMtok: dco_decode_f_64(arr[2]),
  ...
  BridgeModelPricing dco_decode_bridge_model_pricing(dynamic raw) {
    ...
    return BridgeModelPricing(
      ...
      tiers: dco_decode_list_bridge_model_price_tier(arr[1]),
      source: dco_decode_String(arr[2]),
      verifiedAt: dco_decode_i_64(arr[3]),
    );
  }
  ...
  BridgePersistenceQueueSnapshot dco_decode_bridge_persistence_queue_snapshot(
    ...
    if (arr.length != 8)
      throw Exception('unexpected arr length: expect 8 but see ${arr.length}');
    return BridgePersistenceQueueSnapshot(
      statisticsGap: dco_decode_bool(arr[0]),
      pendingOperations: dco_decode_u_64(arr[1]),
      pendingBytes: dco_decode_u_64(arr[2]),
      inFlightBytes: dco_decode_u_64(arr[3]),
      oldestPendingAgeMillis: dco_decode_opt_box_autoadd_u_64(arr[4]),
      lastError: dco_decode_opt_String(arr[5]),
      pressurePaused: dco_decode_bool(arr[6]),
      threads: dco_decode_list_bridge_thread_persistence_snapshot(arr[7]),
    );
  }
  ...
  BridgePurposeCostSnapshot dco_decode_bridge_purpose_cost_snapshot(
    ...
    if (arr.length != 3)
      throw Exception('unexpected arr length: expect 3 but see ${arr.length}');
    return BridgePurposeCostSnapshot(
  ...
  BridgeSessionCostSnapshot dco_decode_bridge_session_cost_snapshot(
    ...
    return BridgeSessionCostSnapshot(
      ...
      purposeCosts: dco_decode_list_bridge_purpose_cost_snapshot(arr[1]),
      estimatedCosts: dco_decode_list_bridge_runtime_cost_amount(arr[2]),
      hasUnpricedUsage: dco_decode_bool(arr[3]),
    );
  }
  ...
  BridgeShutdownProgress dco_decode_bridge_shutdown_progress(dynamic raw) {
    ...
    switch (raw[0]) {
      ...
      case 3:
        return BridgeShutdownProgress_StoppingAgents();
      case 4:
  ...
  BridgeSkillSearchResult dco_decode_bridge_skill_search_result(dynamic raw) {
    ...
    if (arr.length != 4)
      throw Exception('unexpected arr length: expect 4 but see ${arr.length}');
    return BridgeSkillSearchResult(
      projectId: dco_decode_String(arr[0]),
      catalogRevision: dco_decode_u_64(arr[1]),
      matches: dco_decode_list_skill_summary_dto(arr[2]),
  ...
  @protected
  BridgeThreadActivity dco_decode_bridge_thread_activity(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 10)
      throw Exception('unexpected arr length: expect 10 but see ${arr.length}');
    return BridgeThreadActivity(
      threadId: dco_decode_String(arr[0]),
      identity: dco_decode_String(arr[1]),
      revision: dco_decode_u_64(arr[2]),
      turnId: dco_decode_String(arr[3]),
      inputId: dco_decode_opt_String(arr[4]),
      attemptId: dco_decode_opt_String(arr[5]),
      kind: dco_decode_bridge_thread_activity_kind(arr[6]),
      summary: dco_decode_String(arr[7]),
      summaryTruncated: dco_decode_bool(arr[8]),
      tools: dco_decode_bridge_thread_activity_tools(arr[9]),
    );
  }

  @protected
  BridgeThreadActivityArguments dco_decode_bridge_thread_activity_arguments(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return BridgeThreadActivityArguments.values[raw as int];
  }

  @protected
  BridgeThreadActivityContentPart
  dco_decode_bridge_thread_activity_content_part(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 4)
      throw Exception('unexpected arr length: expect 4 but see ${arr.length}');
    return BridgeThreadActivityContentPart(
  ...
  @protected
  BridgeThreadActivityDetail dco_decode_bridge_thread_activity_detail(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    switch (raw[0]) {
      case 0:
        return BridgeThreadActivityDetail_Current(
          activity: dco_decode_box_autoadd_bridge_thread_activity(raw[1]),
          reasoning: dco_decode_list_bridge_thread_activity_content_part(
            raw[2],
          ),
          response: dco_decode_list_bridge_thread_activity_content_part(raw[3]),
          tools: dco_decode_list_bridge_thread_activity_tool_detail(raw[4]),
        );
      case 1:
        return BridgeThreadActivityDetail_Superseded(
          activity: dco_decode_box_autoadd_bridge_thread_activity(raw[1]),
          requestedActivityId: dco_decode_String(raw[2]),
        );
      case 2:
        return BridgeThreadActivityDetail_Ended(
          threadId: dco_decode_String(raw[1]),
          activityId: dco_decode_String(raw[2]),
        );
      default:
        throw Exception("unreachable");
    }
  ...
  @protected
  BridgeThreadActivityKind dco_decode_bridge_thread_activity_kind(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return BridgeThreadActivityKind.values[raw as int];
  }

  @protected
  BridgeThreadActivityToolDetail dco_decode_bridge_thread_activity_tool_detail(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 8)
      throw Exception('unexpected arr length: expect 8 but see ${arr.length}');
    return BridgeThreadActivityToolDetail(
      callId: dco_decode_String(arr[0]),
      taskId: dco_decode_opt_String(arr[1]),
      name: dco_decode_String(arr[2]),
      state: dco_decode_bridge_thread_activity_tool_state(arr[3]),
      arguments: dco_decode_opt_String(arr[4]),
      output: dco_decode_opt_String(arr[5]),
      ordinal: dco_decode_opt_box_autoadd_u_64(arr[6]),
      startedAt: dco_decode_opt_box_autoadd_i_64(arr[7]),
    );
  }

  @protected
  BridgeThreadActivityToolEntry dco_decode_bridge_thread_activity_tool_entry(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 8)
      throw Exception('unexpected arr length: expect 8 but see ${arr.length}');
    return BridgeThreadActivityToolEntry(
      callId: dco_decode_String(arr[0]),
      taskId: dco_decode_opt_String(arr[1]),
      name: dco_decode_String(arr[2]),
      summary: dco_decode_String(arr[3]),
      arguments: dco_decode_bridge_thread_activity_arguments(arr[4]),
      state: dco_decode_bridge_thread_activity_tool_state(arr[5]),
      ordinal: dco_decode_opt_box_autoadd_u_64(arr[6]),
      startedAt: dco_decode_opt_box_autoadd_i_64(arr[7]),
    );
  }
  ...
  @protected
  BridgeThreadActivityToolState dco_decode_bridge_thread_activity_tool_state(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return BridgeThreadActivityToolState.values[raw as int];
  }

  @protected
  BridgeThreadActivityTools dco_decode_bridge_thread_activity_tools(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 4)
      throw Exception('unexpected arr length: expect 4 but see ${arr.length}');
    return BridgeThreadActivityTools(
      count: dco_decode_u_32(arr[0]),
      background: dco_decode_u_32(arr[1]),
      active: dco_decode_list_bridge_thread_activity_tool_entry(arr[2]),
      latestStarted:
          dco_decode_opt_box_autoadd_bridge_thread_activity_tool_entry(arr[3]),
    );
  }
  ...
  BridgeThreadItemState dco_decode_bridge_thread_item_state(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return BridgeThreadItemState_Raw(
          payloads: dco_decode_list_bridge_raw_payload(raw[1]),
          notice: dco_decode_String(raw[2]),
          recordedAt: dco_decode_i_64(raw[3]),
        );
      case 1:
      ...
      case 5:
        return BridgeThreadItemState_Turn(
          ...
          inputId: dco_decode_opt_String(raw[2]),
        );
      case 6:
      ...
      case 9:
        return BridgeThreadItemState_ContextCompaction(
          beforeTokens: dco_decode_opt_box_autoadd_u_64(raw[1]),
          afterTokens: dco_decode_opt_box_autoadd_u_64(raw[2]),
  ...
  dco_decode_bridge_thread_mode_catalog_snapshot(dynamic raw) {
    ...
    if (arr.length != 2)
      throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
    return BridgeThreadModeCatalogSnapshot(
      revision: dco_decode_u_64(arr[0]),
      modes: dco_decode_list_bridge_thread_mode_descriptor(arr[1]),
    );
  }
  ...
  BridgeThreadModeDescriptor dco_decode_bridge_thread_mode_descriptor(
    ...
    if (arr.length != 5)
      throw Exception('unexpected arr length: expect 5 but see ${arr.length}');
    return BridgeThreadModeDescriptor(
      id: dco_decode_String(arr[0]),
      displayName: dco_decode_String(arr[1]),
      description: dco_decode_String(arr[2]),
      order: dco_decode_u_32(arr[3]),
      hasWorkflow: dco_decode_bool(arr[4]),
    );
  }
  ...
  BridgeThreadNotification dco_decode_bridge_thread_notification(dynamic raw) {
    ...
    switch (raw[0]) {
      ...
      case 5:
        return BridgeThreadNotification_ActivityChanged(
          activity: dco_decode_opt_box_bridge_thread_activity(raw[1]),
        );
      case 6:
        return BridgeThreadNotification_StorageChanged(
          storage: dco_decode_opt_box_bridge_thread_storage_state(raw[1]),
        );
      case 7:
  ...
  dco_decode_bridge_thread_notification_envelope(dynamic raw) {
    ...
    return BridgeThreadNotificationEnvelope(
      ...
      notification: dco_decode_bridge_thread_notification(arr[5]),
    );
  }

  @protected
  BridgeThreadPersistenceSnapshot dco_decode_bridge_thread_persistence_snapshot(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    ...
    return BridgeThreadPersistenceSnapshot(
      threadId: dco_decode_String(arr[0]),
      faultGeneration: dco_decode_u_64(arr[1]),
      fault: dco_decode_opt_String(arr[2]),
      stateDirtyRevision: dco_decode_opt_box_autoadd_u_64(arr[3]),
      stateSavingRevision: dco_decode_opt_box_autoadd_u_64(arr[4]),
      stateDurableRevision: dco_decode_opt_box_autoadd_u_64(arr[5]),
      historyAdmittedSequence: dco_decode_opt_box_autoadd_u_64(arr[6]),
      historyDurableSequence: dco_decode_opt_box_autoadd_u_64(arr[7]),
      callsAdmittedSequence: dco_decode_opt_box_autoadd_u_64(arr[8]),
      callsDurableSequence: dco_decode_opt_box_autoadd_u_64(arr[9]),
      pendingOperations: dco_decode_u_64(arr[10]),
      pendingBytes: dco_decode_u_64(arr[11]),
      oldestPendingAgeMillis: dco_decode_opt_box_autoadd_u_64(arr[12]),
      inFlightBytes: dco_decode_u_64(arr[13]),
      lastError: dco_decode_opt_String(arr[14]),
      pressurePaused: dco_decode_bool(arr[15]),
    );
  }
  ...
  BridgeThreadRuntimeUsage dco_decode_bridge_thread_runtime_usage(dynamic raw) {
    ...
    return BridgeThreadRuntimeUsage(
      hasIncompleteUsage: dco_decode_bool(arr[0]),
      model: dco_decode_String(arr[1]),
  ...
  BridgeThreadSnapshot dco_decode_bridge_thread_snapshot(dynamic raw) {
    ...
    return BridgeThreadSnapshot(
      ...
      interactions: dco_decode_list_bridge_interaction_request(arr[4]),
      runtime: dco_decode_opt_box_autoadd_bridge_thread_runtime_snapshot(
        arr[5],
      ),
      activity: dco_decode_opt_box_autoadd_bridge_thread_activity(arr[6]),
      storage: dco_decode_opt_box_autoadd_bridge_thread_storage_state(arr[7]),
  ...
  @protected
  BridgeThreadStorageExecution dco_decode_bridge_thread_storage_execution(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return BridgeThreadStorageExecution.values[raw as int];
  }

  @protected
  BridgeThreadStorageState dco_decode_bridge_thread_storage_state(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 9)
      throw Exception('unexpected arr length: expect 9 but see ${arr.length}');
    return BridgeThreadStorageState(
      fault: dco_decode_opt_box_autoadd_bridge_history_fault(arr[0]),
      faultGeneration: dco_decode_u_64(arr[1]),
      acceptedSequence: dco_decode_opt_box_autoadd_u_64(arr[2]),
      durableSequence: dco_decode_opt_box_autoadd_u_64(arr[3]),
      execution: dco_decode_bridge_thread_storage_execution(arr[4]),
      pressurePaused: dco_decode_bool(arr[5]),
      resumeRequired: dco_decode_bool(arr[6]),
      canResume: dco_decode_bool(arr[7]),
  ...
  BridgeThreadToolInvocation dco_decode_bridge_thread_tool_invocation(
    ...
    return BridgeThreadToolInvocation(
      ...
      callId: dco_decode_opt_String(arr[2]),
      providerItemId: dco_decode_opt_String(arr[3]),
      name: dco_decode_String(arr[4]),
      arguments: dco_decode_String(arr[5]),
  ...
  BridgeThreadToolState dco_decode_bridge_thread_tool_state(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return BridgeThreadToolState_Queued();
      case 1:
        return BridgeThreadToolState_Cancelling(
          streamedOutput: dco_decode_String(raw[1]),
        );
      case 2:
        return BridgeThreadToolState_Interrupted(
          interruptedAt: dco_decode_i_64(raw[1]),
          reason: dco_decode_String(raw[2]),
        );
      case 3:
  ...
  @protected
  BridgeTimelineItemPreview dco_decode_bridge_timeline_item_preview(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 6)
      throw Exception('unexpected arr length: expect 6 but see ${arr.length}');
    return BridgeTimelineItemPreview(
      itemId: dco_decode_String(arr[0]),
      ordinal: dco_decode_u_64(arr[1]),
      revision: dco_decode_u_64(arr[2]),
      totalBytes: dco_decode_u_64(arr[3]),
      previewBytes: dco_decode_u_64(arr[4]),
      omittedBytes: dco_decode_u_64(arr[5]),
    );
  }
  ...
  BridgeTimelinePage dco_decode_bridge_timeline_page(dynamic raw) {
    ...
    if (arr.length != 11)
      throw Exception('unexpected arr length: expect 11 but see ${arr.length}');
    return BridgeTimelinePage(
      threadId: dco_decode_String(arr[0]),
      databaseId: dco_decode_String(arr[1]),
      watermark: dco_decode_u_64(arr[2]),
      items: dco_decode_list_bridge_thread_item(arr[3]),
      olderCursor: dco_decode_opt_String(arr[4]),
      newerCursor: dco_decode_opt_String(arr[5]),
      firstItemId: dco_decode_opt_String(arr[6]),
      lastItemId: dco_decode_opt_String(arr[7]),
      truncated: dco_decode_bool(arr[8]),
      previews: dco_decode_list_bridge_timeline_item_preview(arr[9]),
      turns: dco_decode_list_bridge_timeline_turn(arr[10]),
    );
  }
  ...
  BridgeTimelineQuery dco_decode_bridge_timeline_query(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return BridgeTimelineQuery_Latest();
      case 1:
        return BridgeTimelineQuery_Before(itemId: dco_decode_String(raw[1]));
      case 2:
        return BridgeTimelineQuery_After(itemId: dco_decode_String(raw[1]));
      case 3:
        return BridgeTimelineQuery_Around(itemId: dco_decode_String(raw[1]));
      default:
        throw Exception("unreachable");
    }
  }
  ...
  BridgeTimelineTurn dco_decode_bridge_timeline_turn(dynamic raw) {
    ...
    if (arr.length != 3)
      throw Exception('unexpected arr length: expect 3 but see ${arr.length}');
    return BridgeTimelineTurn(
      turn: dco_decode_bridge_turn(arr[0]),
      lastItemId: dco_decode_String(arr[1]),
      contextDisposition: dco_decode_bridge_thread_context_disposition(arr[2]),
    );
  }
  ...
  BridgeTurn dco_decode_bridge_turn(dynamic raw) {
    ...
    if (arr.length != 6)
      throw Exception('unexpected arr length: expect 6 but see ${arr.length}');
    return BridgeTurn(
      inputId: dco_decode_opt_String(arr[0]),
      id: dco_decode_String(arr[1]),
      threadId: dco_decode_String(arr[2]),
      revision: dco_decode_u_64(arr[3]),
      state: dco_decode_bridge_turn_state(arr[4]),
      updatedAt: dco_decode_i_64(arr[5]),
    );
  }
  ...
  BridgeTurnCancellationCause dco_decode_bridge_turn_cancellation_cause(
    ...
    switch (raw[0]) {
      case 0:
        return BridgeTurnCancellationCause_Unspecified();
      case 1:
  ...
  @protected
  BridgeUpdatePriority dco_decode_bridge_update_priority(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return BridgeUpdatePriority.values[raw as int];
  }
  ...
  BridgeViewChange dco_decode_bridge_view_change(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return BridgeViewChange_Splice(
          index: dco_decode_u_64(raw[1]),
          remove: dco_decode_u_64(raw[2]),
          items: dco_decode_list_bridge_chat_item(raw[3]),
        );
      case 1:
        return BridgeViewChange_UpdateItem(
          itemId: dco_decode_String(raw[1]),
          expectedRevision: dco_decode_u_64(raw[2]),
          revision: dco_decode_u_64(raw[3]),
          omittedBytes: dco_decode_u_64(raw[4]),
          saved: dco_decode_bool(raw[5]),
          fields: dco_decode_list_bridge_field_update(raw[6]),
        );
      default:
        throw Exception("unreachable");
    }
  ...
  dco_decode_bridge_web_search_provider_capabilities_descriptor(dynamic raw) {
    ...
    return BridgeWebSearchProviderCapabilitiesDescriptor(
      ...
      hostedDialect: dco_decode_String(arr[1]),
      standalone: dco_decode_opt_String(arr[2]),
    );
  }
  ...
  BridgeWorkflowRun dco_decode_bridge_workflow_run(dynamic raw) {
    ...
    if (arr.length != 9)
      throw Exception('unexpected arr length: expect 9 but see ${arr.length}');
    return BridgeWorkflowRun(
      lineageId: dco_decode_String(arr[0]),
      runId: dco_decode_String(arr[1]),
      modeId: dco_decode_String(arr[2]),
      graphRevision: dco_decode_u_64(arr[3]),
      graphHash: dco_decode_String(arr[4]),
      lifecycle: dco_decode_bridge_workflow_run_lifecycle(arr[5]),
      currentStateId: dco_decode_String(arr[6]),
  ...
  BridgeWorkflowRunLifecycle dco_decode_bridge_workflow_run_lifecycle(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return BridgeWorkflowRunLifecycle.values[raw as int];
  }
  ...
  BridgeWorkflowRuntimeSnapshot dco_decode_bridge_workflow_runtime_snapshot(
    ...
    if (arr.length != 2)
      throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
    return BridgeWorkflowRuntimeSnapshot(
      revision: dco_decode_u_64(arr[0]),
      currentRun: dco_decode_opt_box_autoadd_bridge_workflow_run(arr[1]),
    );
  }
  ...
  List<BridgeAgentProfileDto> dco_decode_list_bridge_agent_profile_dto(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_bridge_agent_profile_dto)
        .toList();
  }
  ...
  List<BridgeChatItem> dco_decode_list_bridge_chat_item(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_bridge_chat_item).toList();
  }
  ...
  @protected
  List<BridgeFieldUpdate> dco_decode_list_bridge_field_update(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_bridge_field_update).toList();
  }
  ...
  List<BridgeModelPriceTier> dco_decode_list_bridge_model_price_tier(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_bridge_model_price_tier)
        .toList();
  }
  ...
  List<BridgePurposeCostSnapshot> dco_decode_list_bridge_purpose_cost_snapshot(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_bridge_purpose_cost_snapshot)
        .toList();
  }
  ...
  List<BridgeRawPayload> dco_decode_list_bridge_raw_payload(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_bridge_raw_payload).toList();
  }
  ...
  @protected
  List<BridgeThreadActivityContentPart>
  dco_decode_list_bridge_thread_activity_content_part(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_bridge_thread_activity_content_part)
        .toList();
  }

  @protected
  List<BridgeThreadActivityToolDetail>
  dco_decode_list_bridge_thread_activity_tool_detail(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_bridge_thread_activity_tool_detail)
        .toList();
  }

  @protected
  List<BridgeThreadActivityToolEntry>
  dco_decode_list_bridge_thread_activity_tool_entry(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_bridge_thread_activity_tool_entry)
        .toList();
  }
  ...
  dco_decode_list_bridge_thread_mode_descriptor(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_bridge_thread_mode_descriptor)
        .toList();
  }

  @protected
  List<BridgeThreadPersistenceSnapshot>
  dco_decode_list_bridge_thread_persistence_snapshot(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_bridge_thread_persistence_snapshot)
        .toList();
  }
  ...
  @protected
  List<BridgeTimelineItemPreview> dco_decode_list_bridge_timeline_item_preview(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_bridge_timeline_item_preview)
        .toList();
  }
  ...
  List<BridgeTimelineTurn> dco_decode_list_bridge_timeline_turn(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_bridge_timeline_turn).toList();
  }
  ...
  List<BridgeViewChange> dco_decode_list_bridge_view_change(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_bridge_view_change).toList();
  }
  ...
  ListTimelineItemsRequest dco_decode_list_timeline_items_request(dynamic raw) {
    ...
    if (arr.length != 3)
      throw Exception('unexpected arr length: expect 3 but see ${arr.length}');
    return ListTimelineItemsRequest(
      threadId: dco_decode_String(arr[0]),
      query: dco_decode_bridge_timeline_query(arr[1]),
      limit: dco_decode_u_32(arr[2]),
    );
  }
  ...
  BridgeChatItem? dco_decode_opt_box_autoadd_bridge_chat_item(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_bridge_chat_item(raw);
  }

  @protected
  BridgeChatUpdate? dco_decode_opt_box_autoadd_bridge_chat_update(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_bridge_chat_update(raw);
  }

  @protected
  BridgeHistoryFault? dco_decode_opt_box_autoadd_bridge_history_fault(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null
        ? null
        : dco_decode_box_autoadd_bridge_history_fault(raw);
  }
  ...
  @protected
  BridgeThreadActivity? dco_decode_opt_box_autoadd_bridge_thread_activity(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null
        ? null
        : dco_decode_box_autoadd_bridge_thread_activity(raw);
  }

  @protected
  BridgeThreadActivityToolEntry?
  dco_decode_opt_box_autoadd_bridge_thread_activity_tool_entry(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null
        ? null
        : dco_decode_box_autoadd_bridge_thread_activity_tool_entry(raw);
  }
  ...
  dco_decode_opt_box_autoadd_bridge_thread_storage_state(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null
        ? null
        : dco_decode_box_autoadd_bridge_thread_storage_state(raw);
  }
  ...
  BridgeWorkflowRun? dco_decode_opt_box_autoadd_bridge_workflow_run(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_bridge_workflow_run(raw);
  }
  ...
  @protected
  BridgeThreadActivity? dco_decode_opt_box_bridge_thread_activity(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_bridge_thread_activity(raw);
  }

  @protected
  BridgeThreadStorageState? dco_decode_opt_box_bridge_thread_storage_state(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_bridge_thread_storage_state(raw);
  }
  ...
  ProjectDto dco_decode_project_dto(dynamic raw) {
    ...
    return ProjectDto(
      ...
      sshAlias: dco_decode_opt_String(arr[3]),
  ...
  ProviderInput dco_decode_provider_input(dynamic raw) {
    ...
    return ProviderInput(
      ...
      pricingEnabled: dco_decode_bool(arr[6]),
      defaultModel: dco_decode_String(arr[7]),
      customModels: dco_decode_list_provider_model_input(arr[8]),
  ...
  ProviderModelInput dco_decode_provider_model_input(dynamic raw) {
    ...
    return ProviderModelInput(
      ...
      contextWindow: dco_decode_u_64(arr[3]),
      maxOutputTokens: dco_decode_u_64(arr[4]),
    );
  }
  ...
  sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBridgeChatView(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return BridgeChatViewImpl.frbInternalSseDecode(
  ...
  BridgeChatFocus sse_decode_box_autoadd_bridge_chat_focus(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_bridge_chat_focus(deserializer));
  }
  ...
  BridgeChatItem sse_decode_box_autoadd_bridge_chat_item(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_bridge_chat_item(deserializer));
  }
  ...
  BridgeChatSnapshot sse_decode_box_autoadd_bridge_chat_snapshot(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_bridge_chat_snapshot(deserializer));
  }
  ...
  BridgeChatUpdate sse_decode_box_autoadd_bridge_chat_update(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_bridge_chat_update(deserializer));
  }
  ...
  BridgeDirectoryQuery sse_decode_box_autoadd_bridge_directory_query(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_bridge_directory_query(deserializer));
  }
  ...
  @protected
  BridgeHistoryFault sse_decode_box_autoadd_bridge_history_fault(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_bridge_history_fault(deserializer));
  }
  ...
  @protected
  BridgeThreadActivity sse_decode_box_autoadd_bridge_thread_activity(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_bridge_thread_activity(deserializer));
  }

  @protected
  BridgeThreadActivityToolEntry
  sse_decode_box_autoadd_bridge_thread_activity_tool_entry(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_bridge_thread_activity_tool_entry(deserializer));
  }
  ...
  @protected
  BridgeThreadStorageState sse_decode_box_autoadd_bridge_thread_storage_state(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_bridge_thread_storage_state(deserializer));
  }
  ...
  BridgeWorkflowRun sse_decode_box_autoadd_bridge_workflow_run(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_bridge_workflow_run(deserializer));
  }
  ...
  sse_decode_box_autoadd_bridge_workflow_runtime_snapshot(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_bridge_workflow_runtime_snapshot(deserializer));
  }
  ...
  ListTimelineItemsRequest sse_decode_box_autoadd_list_timeline_items_request(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_list_timeline_items_request(deserializer));
  }
  ...
  @protected
  BridgeThreadActivity sse_decode_box_bridge_thread_activity(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_bridge_thread_activity(deserializer));
  ...
  @protected
  BridgeThreadStorageState sse_decode_box_bridge_thread_storage_state(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_bridge_thread_storage_state(deserializer));
  ...
  BridgeAgentProfileDto sse_decode_bridge_agent_profile_dto(
    ...
    var var_whenToUse = sse_decode_String(deserializer);
    var var_systemInstructions = sse_decode_String(deserializer);
    ...
    return BridgeAgentProfileDto(
      ...
      whenToUse: var_whenToUse,
      systemInstructions: var_systemInstructions,
  ...
  BridgeCacheUsageSummary sse_decode_bridge_cache_usage_summary(
    ...
    var var_cacheReadTokens = sse_decode_u_64(deserializer);
    var var_hitRate = sse_decode_opt_box_autoadd_f_64(deserializer);
    var var_hasIncompleteUsage = sse_decode_bool(deserializer);
    return BridgeCacheUsageSummary(
      inputTokens: var_inputTokens,
      cacheReadTokens: var_cacheReadTokens,
      hitRate: var_hitRate,
      hasIncompleteUsage: var_hasIncompleteUsage,
    );
  }
  ...
  BridgeChatDirection sse_decode_bridge_chat_direction(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return BridgeChatDirection.values[inner];
  }
  ...
  BridgeChatFocus sse_decode_bridge_chat_focus(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      ...
      case 1:
        ...
        return BridgeChatFocus_Around(itemId: var_itemId);
      default:
        throw UnimplementedError('');
    }
  }
  ...
  BridgeChatItem sse_decode_bridge_chat_item(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_item = sse_decode_bridge_thread_item(deserializer);
    var var_saved = sse_decode_bool(deserializer);
    var var_lifecycle = sse_decode_bridge_chat_lifecycle(deserializer);
  ...
  @protected
  BridgeChatLifecycle sse_decode_bridge_chat_lifecycle(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return BridgeChatLifecycle.values[inner];
  }
  ...
  BridgeChatSnapshot sse_decode_bridge_chat_snapshot(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_focus = sse_decode_bridge_chat_focus(deserializer);
  ...
  BridgeChatUpdate sse_decode_bridge_chat_update(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      case 0:
        var var_snapshot = sse_decode_box_autoadd_bridge_chat_snapshot(
          deserializer,
        );
        return BridgeChatUpdate_Reset(snapshot: var_snapshot);
      case 1:
        var var_from = sse_decode_u_64(deserializer);
        var var_to = sse_decode_u_64(deserializer);
        var var_changes = sse_decode_list_bridge_view_change(deserializer);
        var var_hasNewer = sse_decode_bool(deserializer);
        var var_priority = sse_decode_bridge_update_priority(deserializer);
        return BridgeChatUpdate_Patch(
          from: var_from,
          to: var_to,
          changes: var_changes,
  ...
  @protected
  BridgeContentField sse_decode_bridge_content_field(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    ...
    switch (tag_) {
      ...
      case 1:
        ...
        return BridgeContentField_ThinkingSummary(chunkIndex: var_chunkIndex);
      case 2:
        var var_chunkIndex = sse_decode_u_32(deserializer);
        return BridgeContentField_ThinkingContent(chunkIndex: var_chunkIndex);
      case 3:
        return BridgeContentField_ToolArguments();
      case 4:
        return BridgeContentField_ToolResult();
  ...
  BridgeDirectoryFilter sse_decode_bridge_directory_filter(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return BridgeDirectoryFilter.values[inner];
  }
  ...
  BridgeDirectoryQuery sse_decode_bridge_directory_query(
    ...
    var var_filter = sse_decode_bridge_directory_filter(deserializer);
  ...
  @protected
  BridgeFieldChange sse_decode_bridge_field_change(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    ...
    switch (tag_) {
      ...
      case 1:
        ...
        return BridgeFieldChange_Append(text: var_text);
      case 2:
        var var_text = sse_decode_String(deserializer);
        return BridgeFieldChange_Replace(text: var_text);
      case 3:
        return BridgeFieldChange_Remove();
      default:
        throw UnimplementedError('');
  ...
  @protected
  BridgeFieldUpdate sse_decode_bridge_field_update(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_field = sse_decode_bridge_content_field(deserializer);
    var var_change = sse_decode_bridge_field_change(deserializer);
    return BridgeFieldUpdate(field: var_field, change: var_change);
  }
  ...
  @protected
  BridgeHistoryFault sse_decode_bridge_history_fault(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return BridgeHistoryFault.values[inner];
  }
  ...
  BridgeModelPriceTier sse_decode_bridge_model_price_tier(
    ...
    var var_inputPerMtok = sse_decode_f_64(deserializer);
    var var_outputPerMtok = sse_decode_f_64(deserializer);
  ...
  BridgeModelPricing sse_decode_bridge_model_pricing(
    ...
    var var_tiers = sse_decode_list_bridge_model_price_tier(deserializer);
    var var_source = sse_decode_String(deserializer);
    var var_verifiedAt = sse_decode_i_64(deserializer);
    return BridgeModelPricing(
      currency: var_currency,
      tiers: var_tiers,
      source: var_source,
      verifiedAt: var_verifiedAt,
    );
  }
  ...
  BridgePersistenceQueueSnapshot sse_decode_bridge_persistence_queue_snapshot(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_statisticsGap = sse_decode_bool(deserializer);
    var var_pendingOperations = sse_decode_u_64(deserializer);
    var var_pendingBytes = sse_decode_u_64(deserializer);
    var var_inFlightBytes = sse_decode_u_64(deserializer);
    var var_oldestPendingAgeMillis = sse_decode_opt_box_autoadd_u_64(
      deserializer,
    );
    var var_lastError = sse_decode_opt_String(deserializer);
    var var_pressurePaused = sse_decode_bool(deserializer);
    var var_threads = sse_decode_list_bridge_thread_persistence_snapshot(
      deserializer,
    );
    return BridgePersistenceQueueSnapshot(
      statisticsGap: var_statisticsGap,
      pendingOperations: var_pendingOperations,
      pendingBytes: var_pendingBytes,
      inFlightBytes: var_inFlightBytes,
      oldestPendingAgeMillis: var_oldestPendingAgeMillis,
      lastError: var_lastError,
      pressurePaused: var_pressurePaused,
      threads: var_threads,
    );
  }
  ...
  BridgeProviderSettingsDto sse_decode_bridge_provider_settings_dto(
    ...
    var var_hostedWebSearchDialect = sse_decode_String(deserializer);
    ...
    return BridgeProviderSettingsDto(
      ...
      hostedWebSearchDialect: var_hostedWebSearchDialect,
  ...
  BridgeSessionCostSnapshot sse_decode_bridge_session_cost_snapshot(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_rootThreadId = sse_decode_String(deserializer);
    var var_purposeCosts = sse_decode_list_bridge_purpose_cost_snapshot(
      deserializer,
    );
    var var_estimatedCosts = sse_decode_list_bridge_runtime_cost_amount(
      deserializer,
  ...
  BridgeSkillSearchResult sse_decode_bridge_skill_search_result(
    ...
    var var_matches = sse_decode_list_skill_summary_dto(deserializer);
  ...
  BridgeStartupStage sse_decode_bridge_startup_stage(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return BridgeStartupStage.values[inner];
  }
  ...
  BridgeStudioSettingsDto sse_decode_bridge_studio_settings_dto(
    ...
    var var_deepseekWebSearch =
        sse_decode_bridge_deep_seek_web_search_settings_dto(deserializer);
    return BridgeStudioSettingsDto(
      ...
      general: var_general,
      webSearch: var_webSearch,
      deepseekWebSearch: var_deepseekWebSearch,
    );
  }
  ...
  BridgeStudioStateSnapshot sse_decode_bridge_studio_state_snapshot(
    ...
    var var_threadModeCatalog = sse_decode_bridge_thread_mode_catalog_snapshot(
      deserializer,
    );
  ...
  @protected
  BridgeThreadActivity sse_decode_bridge_thread_activity(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_threadId = sse_decode_String(deserializer);
    ...
    var var_attemptId = sse_decode_opt_String(deserializer);
    var var_kind = sse_decode_bridge_thread_activity_kind(deserializer);
    var var_summary = sse_decode_String(deserializer);
    var var_summaryTruncated = sse_decode_bool(deserializer);
    var var_tools = sse_decode_bridge_thread_activity_tools(deserializer);
    return BridgeThreadActivity(
      threadId: var_threadId,
      ...
      kind: var_kind,
      summary: var_summary,
      summaryTruncated: var_summaryTruncated,
      tools: var_tools,
    );
  }

  @protected
  BridgeThreadActivityArguments sse_decode_bridge_thread_activity_arguments(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return BridgeThreadActivityArguments.values[inner];
  }

  @protected
  BridgeThreadActivityContentPart
  sse_decode_bridge_thread_activity_content_part(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_itemId = sse_decode_String(deserializer);
  ...
  @protected
  BridgeThreadActivityDetail sse_decode_bridge_thread_activity_detail(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    ...
    switch (tag_) {
      case 0:
        var var_activity = sse_decode_box_autoadd_bridge_thread_activity(
          deserializer,
        );
        var var_reasoning = sse_decode_list_bridge_thread_activity_content_part(
          deserializer,
        );
        var var_response = sse_decode_list_bridge_thread_activity_content_part(
          deserializer,
        );
        var var_tools = sse_decode_list_bridge_thread_activity_tool_detail(
          deserializer,
        );
        return BridgeThreadActivityDetail_Current(
          activity: var_activity,
      ...
      case 1:
        ...
        var var_requestedActivityId = sse_decode_String(deserializer);
        return BridgeThreadActivityDetail_Superseded(
          activity: var_activity,
          requestedActivityId: var_requestedActivityId,
        );
      case 2:
        var var_threadId = sse_decode_String(deserializer);
        var var_activityId = sse_decode_String(deserializer);
        return BridgeThreadActivityDetail_Ended(
          threadId: var_threadId,
  ...
  @protected
  BridgeThreadActivityKind sse_decode_bridge_thread_activity_kind(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return BridgeThreadActivityKind.values[inner];
  }

  @protected
  BridgeThreadActivityToolDetail sse_decode_bridge_thread_activity_tool_detail(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    ...
    var var_name = sse_decode_String(deserializer);
    var var_state = sse_decode_bridge_thread_activity_tool_state(deserializer);
  ...
  @protected
  BridgeThreadActivityToolEntry sse_decode_bridge_thread_activity_tool_entry(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_callId = sse_decode_String(deserializer);
    ...
    var var_name = sse_decode_String(deserializer);
    var var_summary = sse_decode_String(deserializer);
    var var_arguments = sse_decode_bridge_thread_activity_arguments(
      deserializer,
    );
    var var_state = sse_decode_bridge_thread_activity_tool_state(deserializer);
    var var_ordinal = sse_decode_opt_box_autoadd_u_64(deserializer);
  ...
  @protected
  BridgeThreadActivityToolState sse_decode_bridge_thread_activity_tool_state(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return BridgeThreadActivityToolState.values[inner];
  }

  @protected
  BridgeThreadActivityTools sse_decode_bridge_thread_activity_tools(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_count = sse_decode_u_32(deserializer);
    var var_background = sse_decode_u_32(deserializer);
    var var_active = sse_decode_list_bridge_thread_activity_tool_entry(
      deserializer,
    );
    var var_latestStarted =
        sse_decode_opt_box_autoadd_bridge_thread_activity_tool_entry(
          deserializer,
        );
    return BridgeThreadActivityTools(
      count: var_count,
      ...
      active: var_active,
      latestStarted: var_latestStarted,
    );
  }
  ...
  BridgeThreadItemState sse_decode_bridge_thread_item_state(
    ...
    switch (tag_) {
      case 0:
        var var_payloads = sse_decode_list_bridge_raw_payload(deserializer);
        var var_notice = sse_decode_String(deserializer);
        var var_recordedAt = sse_decode_i_64(deserializer);
        return BridgeThreadItemState_Raw(
      ...
      case 9:
        var var_beforeTokens = sse_decode_opt_box_autoadd_u_64(deserializer);
        var var_afterTokens = sse_decode_opt_box_autoadd_u_64(deserializer);
  ...
  sse_decode_bridge_thread_mode_catalog_snapshot(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_revision = sse_decode_u_64(deserializer);
    var var_modes = sse_decode_list_bridge_thread_mode_descriptor(deserializer);
    return BridgeThreadModeCatalogSnapshot(
      revision: var_revision,
      modes: var_modes,
    );
  ...
  BridgeThreadModeDescriptor sse_decode_bridge_thread_mode_descriptor(
    ...
    var var_hasWorkflow = sse_decode_bool(deserializer);
    return BridgeThreadModeDescriptor(
      id: var_id,
      displayName: var_displayName,
      description: var_description,
      order: var_order,
      hasWorkflow: var_hasWorkflow,
    );
  }
  ...
  BridgeThreadNotification sse_decode_bridge_thread_notification(
    ...
    switch (tag_) {
      ...
      case 5:
        var var_activity = sse_decode_opt_box_bridge_thread_activity(
          deserializer,
        );
        return BridgeThreadNotification_ActivityChanged(activity: var_activity);
      case 6:
        var var_storage = sse_decode_opt_box_bridge_thread_storage_state(
          deserializer,
        );
        return BridgeThreadNotification_StorageChanged(storage: var_storage);
      case 7:
  ...
  @protected
  BridgeThreadPersistenceSnapshot sse_decode_bridge_thread_persistence_snapshot(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_threadId = sse_decode_String(deserializer);
    var var_faultGeneration = sse_decode_u_64(deserializer);
    var var_fault = sse_decode_opt_String(deserializer);
    var var_stateDirtyRevision = sse_decode_opt_box_autoadd_u_64(deserializer);
    var var_stateSavingRevision = sse_decode_opt_box_autoadd_u_64(deserializer);
    var var_stateDurableRevision = sse_decode_opt_box_autoadd_u_64(
      deserializer,
    );
    var var_historyAdmittedSequence = sse_decode_opt_box_autoadd_u_64(
      deserializer,
    );
    var var_historyDurableSequence = sse_decode_opt_box_autoadd_u_64(
      deserializer,
    );
    var var_callsAdmittedSequence = sse_decode_opt_box_autoadd_u_64(
      deserializer,
    );
    var var_callsDurableSequence = sse_decode_opt_box_autoadd_u_64(
      deserializer,
    );
    var var_pendingOperations = sse_decode_u_64(deserializer);
    var var_pendingBytes = sse_decode_u_64(deserializer);
    ...
    return BridgeThreadPersistenceSnapshot(
      threadId: var_threadId,
      faultGeneration: var_faultGeneration,
      fault: var_fault,
      stateDirtyRevision: var_stateDirtyRevision,
      stateSavingRevision: var_stateSavingRevision,
      stateDurableRevision: var_stateDurableRevision,
      historyAdmittedSequence: var_historyAdmittedSequence,
      historyDurableSequence: var_historyDurableSequence,
      callsAdmittedSequence: var_callsAdmittedSequence,
      callsDurableSequence: var_callsDurableSequence,
      pendingOperations: var_pendingOperations,
      pendingBytes: var_pendingBytes,
      oldestPendingAgeMillis: var_oldestPendingAgeMillis,
      inFlightBytes: var_inFlightBytes,
  ...
  BridgeThreadRuntimeUsage sse_decode_bridge_thread_runtime_usage(
    ...
    var var_cacheUsage = sse_decode_bridge_cache_usage_summary(deserializer);
    var var_estimatedCosts = sse_decode_list_bridge_runtime_cost_amount(
      deserializer,
    );
  ...
  BridgeThreadSnapshot sse_decode_bridge_thread_snapshot(
    ...
    var var_activity = sse_decode_opt_box_autoadd_bridge_thread_activity(
      deserializer,
    );
    var var_storage = sse_decode_opt_box_autoadd_bridge_thread_storage_state(
      deserializer,
    );
  ...
  @protected
  BridgeThreadStorageExecution sse_decode_bridge_thread_storage_execution(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return BridgeThreadStorageExecution.values[inner];
  }

  @protected
  BridgeThreadStorageState sse_decode_bridge_thread_storage_state(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_fault = sse_decode_opt_box_autoadd_bridge_history_fault(
      deserializer,
    );
    var var_faultGeneration = sse_decode_u_64(deserializer);
    var var_acceptedSequence = sse_decode_opt_box_autoadd_u_64(deserializer);
    var var_durableSequence = sse_decode_opt_box_autoadd_u_64(deserializer);
    var var_execution = sse_decode_bridge_thread_storage_execution(
      deserializer,
    );
    var var_pressurePaused = sse_decode_bool(deserializer);
    var var_resumeRequired = sse_decode_bool(deserializer);
    var var_canResume = sse_decode_bool(deserializer);
    var var_lastError = sse_decode_opt_String(deserializer);
    return BridgeThreadStorageState(
      fault: var_fault,
      faultGeneration: var_faultGeneration,
      acceptedSequence: var_acceptedSequence,
      durableSequence: var_durableSequence,
      execution: var_execution,
      pressurePaused: var_pressurePaused,
      resumeRequired: var_resumeRequired,
  ...
  BridgeThreadToolState sse_decode_bridge_thread_tool_state(
    ...
    switch (tag_) {
      ...
      case 2:
        var var_interruptedAt = sse_decode_i_64(deserializer);
        var var_reason = sse_decode_String(deserializer);
        return BridgeThreadToolState_Interrupted(
          interruptedAt: var_interruptedAt,
          reason: var_reason,
        );
      case 3:
        return BridgeThreadToolState_Started();
  ...
  @protected
  BridgeTimelineItemPreview sse_decode_bridge_timeline_item_preview(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_itemId = sse_decode_String(deserializer);
    ...
    var var_previewBytes = sse_decode_u_64(deserializer);
    var var_omittedBytes = sse_decode_u_64(deserializer);
    return BridgeTimelineItemPreview(
      itemId: var_itemId,
      ordinal: var_ordinal,
  ...
  BridgeTimelinePage sse_decode_bridge_timeline_page(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_threadId = sse_decode_String(deserializer);
    var var_databaseId = sse_decode_String(deserializer);
    var var_watermark = sse_decode_u_64(deserializer);
    var var_items = sse_decode_list_bridge_thread_item(deserializer);
    var var_olderCursor = sse_decode_opt_String(deserializer);
    var var_newerCursor = sse_decode_opt_String(deserializer);
    var var_firstItemId = sse_decode_opt_String(deserializer);
    var var_lastItemId = sse_decode_opt_String(deserializer);
    var var_truncated = sse_decode_bool(deserializer);
    var var_previews = sse_decode_list_bridge_timeline_item_preview(
      deserializer,
    );
    var var_turns = sse_decode_list_bridge_timeline_turn(deserializer);
    return BridgeTimelinePage(
      threadId: var_threadId,
      databaseId: var_databaseId,
      watermark: var_watermark,
      items: var_items,
      olderCursor: var_olderCursor,
      newerCursor: var_newerCursor,
      firstItemId: var_firstItemId,
      lastItemId: var_lastItemId,
      truncated: var_truncated,
  ...
  BridgeTimelineQuery sse_decode_bridge_timeline_query(
    ...
    switch (tag_) {
      ...
      case 1:
        var var_itemId = sse_decode_String(deserializer);
        return BridgeTimelineQuery_Before(itemId: var_itemId);
      case 2:
        var var_itemId = sse_decode_String(deserializer);
        return BridgeTimelineQuery_After(itemId: var_itemId);
      case 3:
        var var_itemId = sse_decode_String(deserializer);
        return BridgeTimelineQuery_Around(itemId: var_itemId);
      default:
        throw UnimplementedError('');
    }
  }
  ...
  BridgeTimelineTurn sse_decode_bridge_timeline_turn(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_turn = sse_decode_bridge_turn(deserializer);
    var var_lastItemId = sse_decode_String(deserializer);
    var var_contextDisposition = sse_decode_bridge_thread_context_disposition(
      deserializer,
    );
    return BridgeTimelineTurn(
  ...
  @protected
  BridgeUpdatePriority sse_decode_bridge_update_priority(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return BridgeUpdatePriority.values[inner];
  }
  ...
  BridgeViewChange sse_decode_bridge_view_change(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      case 0:
        ...
        var var_remove = sse_decode_u_64(deserializer);
        var var_items = sse_decode_list_bridge_chat_item(deserializer);
        return BridgeViewChange_Splice(
          index: var_index,
          remove: var_remove,
      ...
      case 1:
        ...
        var var_omittedBytes = sse_decode_u_64(deserializer);
        var var_saved = sse_decode_bool(deserializer);
        var var_fields = sse_decode_list_bridge_field_update(deserializer);
        return BridgeViewChange_UpdateItem(
          itemId: var_itemId,
  ...
  BridgeWorkflowRun sse_decode_bridge_workflow_run(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_lineageId = sse_decode_String(deserializer);
    var var_runId = sse_decode_String(deserializer);
    var var_modeId = sse_decode_String(deserializer);
    var var_graphRevision = sse_decode_u_64(deserializer);
    var var_graphHash = sse_decode_String(deserializer);
    var var_lifecycle = sse_decode_bridge_workflow_run_lifecycle(deserializer);
    var var_currentStateId = sse_decode_String(deserializer);
    var var_startedAt = sse_decode_i_64(deserializer);
    var var_updatedAt = sse_decode_i_64(deserializer);
    return BridgeWorkflowRun(
      lineageId: var_lineageId,
      runId: var_runId,
      modeId: var_modeId,
      graphRevision: var_graphRevision,
      graphHash: var_graphHash,
      lifecycle: var_lifecycle,
      currentStateId: var_currentStateId,
      startedAt: var_startedAt,
      updatedAt: var_updatedAt,
    );
  }
  ...
  BridgeWorkflowRunLifecycle sse_decode_bridge_workflow_run_lifecycle(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return BridgeWorkflowRunLifecycle.values[inner];
  }
  ...
  BridgeWorkflowRuntimeSnapshot sse_decode_bridge_workflow_runtime_snapshot(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_revision = sse_decode_u_64(deserializer);
    var var_currentRun = sse_decode_opt_box_autoadd_bridge_workflow_run(
      deserializer,
    );
    return BridgeWorkflowRuntimeSnapshot(
      revision: var_revision,
  ...
  List<BridgeAgentProfileDto> sse_decode_list_bridge_agent_profile_dto(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <BridgeAgentProfileDto>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_bridge_agent_profile_dto(deserializer));
    }
    return ans_;
  }
  ...
  List<BridgeChatItem> sse_decode_list_bridge_chat_item(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <BridgeChatItem>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_bridge_chat_item(deserializer));
    }
    return ans_;
  }
  ...
  @protected
  List<BridgeFieldUpdate> sse_decode_list_bridge_field_update(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <BridgeFieldUpdate>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_bridge_field_update(deserializer));
    }
    return ans_;
  }
  ...
  List<BridgeModelPriceTier> sse_decode_list_bridge_model_price_tier(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <BridgeModelPriceTier>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_bridge_model_price_tier(deserializer));
    }
    return ans_;
  }
  ...
  List<BridgePurposeCostSnapshot> sse_decode_list_bridge_purpose_cost_snapshot(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <BridgePurposeCostSnapshot>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_bridge_purpose_cost_snapshot(deserializer));
    }
    return ans_;
  }
  ...
  List<BridgeRawPayload> sse_decode_list_bridge_raw_payload(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <BridgeRawPayload>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_bridge_raw_payload(deserializer));
    }
    return ans_;
  }
  ...
  @protected
  List<BridgeThreadActivityContentPart>
  sse_decode_list_bridge_thread_activity_content_part(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <BridgeThreadActivityContentPart>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_bridge_thread_activity_content_part(deserializer));
    }
    return ans_;
  }
  ...
  @protected
  List<BridgeThreadActivityToolDetail>
  sse_decode_list_bridge_thread_activity_tool_detail(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <BridgeThreadActivityToolDetail>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_bridge_thread_activity_tool_detail(deserializer));
    }
    return ans_;
  }
  ...
  @protected
  List<BridgeThreadActivityToolEntry>
  sse_decode_list_bridge_thread_activity_tool_entry(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <BridgeThreadActivityToolEntry>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_bridge_thread_activity_tool_entry(deserializer));
    }
    return ans_;
  }
  ...
  sse_decode_list_bridge_thread_mode_descriptor(SseDeserializer deserializer) {
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <BridgeThreadModeDescriptor>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_bridge_thread_mode_descriptor(deserializer));
    }
    return ans_;
  }
  ...
  @protected
  List<BridgeThreadPersistenceSnapshot>
  sse_decode_list_bridge_thread_persistence_snapshot(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <BridgeThreadPersistenceSnapshot>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_bridge_thread_persistence_snapshot(deserializer));
    }
    return ans_;
  }
  ...
  @protected
  List<BridgeTimelineItemPreview> sse_decode_list_bridge_timeline_item_preview(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <BridgeTimelineItemPreview>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_bridge_timeline_item_preview(deserializer));
    }
    return ans_;
  }
  ...
  List<BridgeTimelineTurn> sse_decode_list_bridge_timeline_turn(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <BridgeTimelineTurn>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_bridge_timeline_turn(deserializer));
    }
    return ans_;
  }
  ...
  List<BridgeViewChange> sse_decode_list_bridge_view_change(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <BridgeViewChange>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_bridge_view_change(deserializer));
    }
    return ans_;
  }
  ...
  ListTimelineItemsRequest sse_decode_list_timeline_items_request(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_threadId = sse_decode_String(deserializer);
    var var_query = sse_decode_bridge_timeline_query(deserializer);
    var var_limit = sse_decode_u_32(deserializer);
    return ListTimelineItemsRequest(
      threadId: var_threadId,
      query: var_query,
  ...
  BridgeChatItem? sse_decode_opt_box_autoadd_bridge_chat_item(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_bridge_chat_item(deserializer));
    } else {
      return null;
    }
  }
  ...
  BridgeChatUpdate? sse_decode_opt_box_autoadd_bridge_chat_update(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_bridge_chat_update(deserializer));
    } else {
      return null;
    }
  }
  ...
  @protected
  BridgeHistoryFault? sse_decode_opt_box_autoadd_bridge_history_fault(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_bridge_history_fault(deserializer));
    } else {
      return null;
    }
  }
  ...
  BridgeStateError? sse_decode_opt_box_autoadd_bridge_state_error(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_bridge_state_error(deserializer));
    } else {
      return null;
    }
  }
  ...
  @protected
  BridgeThreadActivity? sse_decode_opt_box_autoadd_bridge_thread_activity(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_bridge_thread_activity(deserializer));
    } else {
      return null;
    }
  }
  ...
  sse_decode_opt_box_autoadd_bridge_thread_activity_tool_entry(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_bridge_thread_activity_tool_entry(
        deserializer,
      ));
    } else {
      return null;
  ...
  @protected
  BridgeThreadStorageState?
  sse_decode_opt_box_autoadd_bridge_thread_storage_state(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_bridge_thread_storage_state(deserializer));
    } else {
      return null;
    }
  }
  ...
  BridgeWorkflowRun? sse_decode_opt_box_autoadd_bridge_workflow_run(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_bridge_workflow_run(deserializer));
    } else {
      return null;
    }
  }
  ...
  @protected
  BridgeThreadActivity? sse_decode_opt_box_bridge_thread_activity(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_bridge_thread_activity(deserializer));
    } else {
      return null;
    }
  }
  ...
  @protected
  BridgeThreadStorageState? sse_decode_opt_box_bridge_thread_storage_state(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_bridge_thread_storage_state(deserializer));
    } else {
      return null;
    }
  }
  ...
  ProjectDto sse_decode_project_dto(SseDeserializer deserializer) {
    ...
    var var_name = sse_decode_String(deserializer);
    var var_path = sse_decode_String(deserializer);
    var var_sshAlias = sse_decode_opt_String(deserializer);
    var var_updatedAt = sse_decode_i_64(deserializer);
    return ProjectDto(
      id: var_id,
      name: var_name,
      path: var_path,
      sshAlias: var_sshAlias,
      updatedAt: var_updatedAt,
    );
  }
  ...
  sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBridgeChatView(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as BridgeChatViewImpl).frbInternalSseEncode(move: true),
      serializer,
    );
  }
  ...
  sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBridgeChatView(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as BridgeChatViewImpl).frbInternalSseEncode(move: false),
      serializer,
    );
  }
  ...
  sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBridgeChatView(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as BridgeChatViewImpl).frbInternalSseEncode(move: null),
      serializer,
    );
  }
  ...
  void sse_encode_box_autoadd_bridge_chat_focus(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_chat_focus(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_bridge_chat_item(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_chat_item(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_bridge_chat_snapshot(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_chat_snapshot(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_bridge_chat_update(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_chat_update(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_bridge_directory_query(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_directory_query(self, serializer);
  }
  ...
  @protected
  void sse_encode_box_autoadd_bridge_history_fault(
    BridgeHistoryFault self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_history_fault(self, serializer);
  }
  ...
  @protected
  void sse_encode_box_autoadd_bridge_thread_activity(
    BridgeThreadActivity self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_thread_activity(self, serializer);
  }

  @protected
  void sse_encode_box_autoadd_bridge_thread_activity_tool_entry(
    BridgeThreadActivityToolEntry self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_thread_activity_tool_entry(self, serializer);
  }
  ...
  @protected
  void sse_encode_box_autoadd_bridge_thread_storage_state(
    BridgeThreadStorageState self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_thread_storage_state(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_bridge_workflow_run(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_workflow_run(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_bridge_workflow_runtime_snapshot(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_workflow_runtime_snapshot(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_list_timeline_items_request(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_list_timeline_items_request(self, serializer);
  }
  ...
  @protected
  void sse_encode_box_bridge_thread_activity(
    BridgeThreadActivity self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
  ...
  @protected
  void sse_encode_box_bridge_thread_storage_state(
    BridgeThreadStorageState self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
  ...
  void sse_encode_bridge_agent_profile_dto(
    ...
    sse_encode_String(self.whenToUse, serializer);
    sse_encode_String(self.systemInstructions, serializer);
  ...
  void sse_encode_bridge_cache_usage_summary(
    ...
    sse_encode_u_64(self.cacheReadTokens, serializer);
    sse_encode_opt_box_autoadd_f_64(self.hitRate, serializer);
    sse_encode_bool(self.hasIncompleteUsage, serializer);
  }
  ...
  void sse_encode_bridge_chat_focus(
    ...
    switch (self) {
      case BridgeChatFocus_Latest():
        sse_encode_i_32(0, serializer);
      case BridgeChatFocus_Around(itemId: final itemId):
        sse_encode_i_32(1, serializer);
        sse_encode_String(itemId, serializer);
    }
  }
  ...
  void sse_encode_bridge_chat_item(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_thread_item(self.item, serializer);
    sse_encode_bool(self.saved, serializer);
    sse_encode_bridge_chat_lifecycle(self.lifecycle, serializer);
    sse_encode_u_64(self.omittedBytes, serializer);
  }

  @protected
  void sse_encode_bridge_chat_lifecycle(
    BridgeChatLifecycle self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.index, serializer);
  ...
  void sse_encode_bridge_chat_snapshot(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_chat_focus(self.focus, serializer);
  ...
  void sse_encode_bridge_chat_update(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    switch (self) {
      case BridgeChatUpdate_Reset(snapshot: final snapshot):
        sse_encode_i_32(0, serializer);
        sse_encode_box_autoadd_bridge_chat_snapshot(snapshot, serializer);
      case BridgeChatUpdate_Patch(
        from: final from,
        to: final to,
        changes: final changes,
        hasNewer: final hasNewer,
        priority: final priority,
      ):
        sse_encode_i_32(1, serializer);
        sse_encode_u_64(from, serializer);
        sse_encode_u_64(to, serializer);
        sse_encode_list_bridge_view_change(changes, serializer);
        sse_encode_bool(hasNewer, serializer);
        sse_encode_bridge_update_priority(priority, serializer);
    }
  }
  ...
  @protected
  void sse_encode_bridge_content_field(
    BridgeContentField self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    switch (self) {
      case BridgeContentField_Text():
        sse_encode_i_32(0, serializer);
      case BridgeContentField_ThinkingSummary(chunkIndex: final chunkIndex):
        sse_encode_i_32(1, serializer);
        sse_encode_u_32(chunkIndex, serializer);
      case BridgeContentField_ThinkingContent(chunkIndex: final chunkIndex):
        sse_encode_i_32(2, serializer);
        sse_encode_u_32(chunkIndex, serializer);
      case BridgeContentField_ToolArguments():
        sse_encode_i_32(3, serializer);
      case BridgeContentField_ToolResult():
        sse_encode_i_32(4, serializer);
    }
  }
  ...
  void sse_encode_bridge_directory_query(
    ...
    sse_encode_bridge_directory_filter(self.filter, serializer);
  ...
  @protected
  void sse_encode_bridge_field_change(
    BridgeFieldChange self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    switch (self) {
      case BridgeFieldChange_Unchanged():
        sse_encode_i_32(0, serializer);
      case BridgeFieldChange_Append(text: final text):
        sse_encode_i_32(1, serializer);
        sse_encode_String(text, serializer);
      case BridgeFieldChange_Replace(text: final text):
        sse_encode_i_32(2, serializer);
        sse_encode_String(text, serializer);
      case BridgeFieldChange_Remove():
        sse_encode_i_32(3, serializer);
    }
  }

  @protected
  void sse_encode_bridge_field_update(
    BridgeFieldUpdate self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_content_field(self.field, serializer);
    sse_encode_bridge_field_change(self.change, serializer);
  }
  ...
  @protected
  void sse_encode_bridge_history_fault(
    BridgeHistoryFault self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
  ...
  void sse_encode_bridge_model_price_tier(
    ...
    sse_encode_f_64(self.inputPerMtok, serializer);
    sse_encode_f_64(self.outputPerMtok, serializer);
  ...
  void sse_encode_bridge_model_pricing(
    ...
    sse_encode_list_bridge_model_price_tier(self.tiers, serializer);
    sse_encode_String(self.source, serializer);
    sse_encode_i_64(self.verifiedAt, serializer);
  }
  ...
  void sse_encode_bridge_persistence_queue_snapshot(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bool(self.statisticsGap, serializer);
    sse_encode_u_64(self.pendingOperations, serializer);
    sse_encode_u_64(self.pendingBytes, serializer);
    sse_encode_u_64(self.inFlightBytes, serializer);
    sse_encode_opt_box_autoadd_u_64(self.oldestPendingAgeMillis, serializer);
    sse_encode_opt_String(self.lastError, serializer);
    sse_encode_bool(self.pressurePaused, serializer);
    sse_encode_list_bridge_thread_persistence_snapshot(
      self.threads,
      serializer,
    );
  }
  ...
  void sse_encode_bridge_provider_settings_dto(
    ...
    sse_encode_String(self.hostedWebSearchDialect, serializer);
  ...
  void sse_encode_bridge_session_cost_snapshot(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(self.rootThreadId, serializer);
    sse_encode_list_bridge_purpose_cost_snapshot(self.purposeCosts, serializer);
    sse_encode_list_bridge_runtime_cost_amount(self.estimatedCosts, serializer);
    sse_encode_bool(self.hasUnpricedUsage, serializer);
  }
  ...
  void sse_encode_bridge_shutdown_progress(
    ...
    switch (self) {
      ...
      case BridgeShutdownProgress_FlushingPersistence(
        ...
        sse_encode_i_32(2, serializer);
        sse_encode_u_64(pendingCommits, serializer);
      case BridgeShutdownProgress_StoppingAgents():
        sse_encode_i_32(3, serializer);
  ...
  void sse_encode_bridge_skill_search_result(
    ...
    sse_encode_list_skill_summary_dto(self.matches, serializer);
  ...
  void sse_encode_bridge_studio_settings_dto(
    ...
    sse_encode_bridge_deep_seek_web_search_settings_dto(
      self.deepseekWebSearch,
      serializer,
    );
  }
  ...
  void sse_encode_bridge_studio_state_snapshot(
    ...
    sse_encode_bridge_thread_mode_catalog_snapshot(
      self.threadModeCatalog,
      serializer,
    );
  ...
  @protected
  void sse_encode_bridge_thread_activity(
    BridgeThreadActivity self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    ...
    sse_encode_opt_String(self.attemptId, serializer);
    sse_encode_bridge_thread_activity_kind(self.kind, serializer);
    sse_encode_String(self.summary, serializer);
    sse_encode_bool(self.summaryTruncated, serializer);
    sse_encode_bridge_thread_activity_tools(self.tools, serializer);
  }

  @protected
  void sse_encode_bridge_thread_activity_arguments(
    BridgeThreadActivityArguments self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.index, serializer);
  ...
  @protected
  void sse_encode_bridge_thread_activity_content_part(
    BridgeThreadActivityContentPart self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
  ...
  @protected
  void sse_encode_bridge_thread_activity_detail(
    BridgeThreadActivityDetail self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    switch (self) {
      case BridgeThreadActivityDetail_Current(
        ...
        sse_encode_i_32(0, serializer);
        sse_encode_box_autoadd_bridge_thread_activity(activity, serializer);
        sse_encode_list_bridge_thread_activity_content_part(
          reasoning,
          serializer,
        );
        sse_encode_list_bridge_thread_activity_content_part(
        ...
        sse_encode_list_bridge_thread_activity_tool_detail(tools, serializer);
      case BridgeThreadActivityDetail_Superseded(
        activity: final activity,
        requestedActivityId: final requestedActivityId,
      ):
        sse_encode_i_32(1, serializer);
        sse_encode_box_autoadd_bridge_thread_activity(activity, serializer);
        sse_encode_String(requestedActivityId, serializer);
      case BridgeThreadActivityDetail_Ended(
        threadId: final threadId,
  ...
  @protected
  void sse_encode_bridge_thread_activity_kind(
    BridgeThreadActivityKind self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.index, serializer);
  ...
  @protected
  void sse_encode_bridge_thread_activity_tool_detail(
    BridgeThreadActivityToolDetail self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    ...
    sse_encode_String(self.name, serializer);
    sse_encode_bridge_thread_activity_tool_state(self.state, serializer);
  ...
  @protected
  void sse_encode_bridge_thread_activity_tool_entry(
    BridgeThreadActivityToolEntry self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    ...
    sse_encode_String(self.name, serializer);
    sse_encode_String(self.summary, serializer);
    sse_encode_bridge_thread_activity_arguments(self.arguments, serializer);
    sse_encode_bridge_thread_activity_tool_state(self.state, serializer);
    sse_encode_opt_box_autoadd_u_64(self.ordinal, serializer);
    sse_encode_opt_box_autoadd_i_64(self.startedAt, serializer);
  }
  ...
  @protected
  void sse_encode_bridge_thread_activity_tool_state(
    BridgeThreadActivityToolState self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.index, serializer);
  ...
  @protected
  void sse_encode_bridge_thread_activity_tools(
    BridgeThreadActivityTools self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_u_32(self.count, serializer);
    sse_encode_u_32(self.background, serializer);
    sse_encode_list_bridge_thread_activity_tool_entry(self.active, serializer);
    sse_encode_opt_box_autoadd_bridge_thread_activity_tool_entry(
      self.latestStarted,
      serializer,
    );
  }
  ...
  void sse_encode_bridge_thread_item_state(
    ...
    switch (self) {
      case BridgeThreadItemState_Raw(
        ...
        sse_encode_i_32(0, serializer);
        sse_encode_list_bridge_raw_payload(payloads, serializer);
        sse_encode_String(notice, serializer);
        sse_encode_i_64(recordedAt, serializer);
      ...
      case BridgeThreadItemState_ContextCompaction(
        ...
        sse_encode_i_32(9, serializer);
        sse_encode_opt_box_autoadd_u_64(beforeTokens, serializer);
        sse_encode_opt_box_autoadd_u_64(afterTokens, serializer);
  ...
  void sse_encode_bridge_thread_mode_catalog_snapshot(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_u_64(self.revision, serializer);
    sse_encode_list_bridge_thread_mode_descriptor(self.modes, serializer);
  }
  ...
  void sse_encode_bridge_thread_mode_descriptor(
    ...
    sse_encode_bool(self.hasWorkflow, serializer);
  }
  ...
  void sse_encode_bridge_thread_notification(
    ...
    switch (self) {
      ...
      case BridgeThreadNotification_ActivityChanged(activity: final activity):
        sse_encode_i_32(5, serializer);
        sse_encode_opt_box_bridge_thread_activity(activity, serializer);
      case BridgeThreadNotification_StorageChanged(storage: final storage):
        sse_encode_i_32(6, serializer);
        sse_encode_opt_box_bridge_thread_storage_state(storage, serializer);
  ...
  @protected
  void sse_encode_bridge_thread_persistence_snapshot(
    BridgeThreadPersistenceSnapshot self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(self.threadId, serializer);
    sse_encode_u_64(self.faultGeneration, serializer);
    sse_encode_opt_String(self.fault, serializer);
    sse_encode_opt_box_autoadd_u_64(self.stateDirtyRevision, serializer);
    sse_encode_opt_box_autoadd_u_64(self.stateSavingRevision, serializer);
    sse_encode_opt_box_autoadd_u_64(self.stateDurableRevision, serializer);
    sse_encode_opt_box_autoadd_u_64(self.historyAdmittedSequence, serializer);
    sse_encode_opt_box_autoadd_u_64(self.historyDurableSequence, serializer);
    sse_encode_opt_box_autoadd_u_64(self.callsAdmittedSequence, serializer);
    sse_encode_opt_box_autoadd_u_64(self.callsDurableSequence, serializer);
    sse_encode_u_64(self.pendingOperations, serializer);
    sse_encode_u_64(self.pendingBytes, serializer);
    sse_encode_opt_box_autoadd_u_64(self.oldestPendingAgeMillis, serializer);
    sse_encode_u_64(self.inFlightBytes, serializer);
  ...
  void sse_encode_bridge_thread_runtime_snapshot(
    ...
    sse_encode_opt_box_autoadd_bridge_workflow_runtime_snapshot(
      self.workflow,
      serializer,
    );
    sse_encode_i_64(self.updatedAt, serializer);
  ...
  void sse_encode_bridge_thread_runtime_usage(
    ...
    sse_encode_bridge_cache_usage_summary(self.cacheUsage, serializer);
    sse_encode_list_bridge_runtime_cost_amount(self.estimatedCosts, serializer);
  ...
  void sse_encode_bridge_thread_snapshot(
    ...
    sse_encode_opt_box_autoadd_bridge_thread_activity(
      self.activity,
      serializer,
    );
    sse_encode_opt_box_autoadd_bridge_thread_storage_state(
      self.storage,
      serializer,
    );
  ...
  @protected
  void sse_encode_bridge_thread_storage_execution(
    BridgeThreadStorageExecution self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.index, serializer);
  ...
  @protected
  void sse_encode_bridge_thread_storage_state(
    BridgeThreadStorageState self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_opt_box_autoadd_bridge_history_fault(self.fault, serializer);
    sse_encode_u_64(self.faultGeneration, serializer);
    sse_encode_opt_box_autoadd_u_64(self.acceptedSequence, serializer);
    sse_encode_opt_box_autoadd_u_64(self.durableSequence, serializer);
    sse_encode_bridge_thread_storage_execution(self.execution, serializer);
    sse_encode_bool(self.pressurePaused, serializer);
    sse_encode_bool(self.resumeRequired, serializer);
  ...
  void sse_encode_bridge_thread_tool_state(
    ...
    switch (self) {
      case BridgeThreadToolState_Queued():
        sse_encode_i_32(0, serializer);
      case BridgeThreadToolState_Cancelling(
        streamedOutput: final streamedOutput,
      ):
        sse_encode_i_32(1, serializer);
        sse_encode_String(streamedOutput, serializer);
      case BridgeThreadToolState_Interrupted(
        interruptedAt: final interruptedAt,
        reason: final reason,
      ):
        sse_encode_i_32(2, serializer);
        sse_encode_i_64(interruptedAt, serializer);
        sse_encode_String(reason, serializer);
  ...
  @protected
  void sse_encode_bridge_timeline_item_preview(
    BridgeTimelineItemPreview self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(self.itemId, serializer);
    ...
    sse_encode_u_64(self.previewBytes, serializer);
    sse_encode_u_64(self.omittedBytes, serializer);
  }
  ...
  void sse_encode_bridge_timeline_page(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(self.threadId, serializer);
    sse_encode_String(self.databaseId, serializer);
    sse_encode_u_64(self.watermark, serializer);
    sse_encode_list_bridge_thread_item(self.items, serializer);
    sse_encode_opt_String(self.olderCursor, serializer);
    sse_encode_opt_String(self.newerCursor, serializer);
    sse_encode_opt_String(self.firstItemId, serializer);
    sse_encode_opt_String(self.lastItemId, serializer);
    sse_encode_bool(self.truncated, serializer);
    sse_encode_list_bridge_timeline_item_preview(self.previews, serializer);
    sse_encode_list_bridge_timeline_turn(self.turns, serializer);
  }
  ...
  void sse_encode_bridge_timeline_query(
    ...
    switch (self) {
      case BridgeTimelineQuery_Latest():
        sse_encode_i_32(0, serializer);
      case BridgeTimelineQuery_Before(itemId: final itemId):
        sse_encode_i_32(1, serializer);
        sse_encode_String(itemId, serializer);
      case BridgeTimelineQuery_After(itemId: final itemId):
        sse_encode_i_32(2, serializer);
        sse_encode_String(itemId, serializer);
      case BridgeTimelineQuery_Around(itemId: final itemId):
        sse_encode_i_32(3, serializer);
        sse_encode_String(itemId, serializer);
    }
  }
  ...
  void sse_encode_bridge_timeline_turn(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_turn(self.turn, serializer);
    sse_encode_String(self.lastItemId, serializer);
    sse_encode_bridge_thread_context_disposition(
      self.contextDisposition,
      serializer,
    );
  ...
  @protected
  void sse_encode_bridge_update_priority(
    BridgeUpdatePriority self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.index, serializer);
  ...
  void sse_encode_bridge_view_change(
    ...
    switch (self) {
      case BridgeViewChange_Splice(
        ...
        sse_encode_u_64(remove, serializer);
        sse_encode_list_bridge_chat_item(items, serializer);
      case BridgeViewChange_UpdateItem(
        itemId: final itemId,
        expectedRevision: final expectedRevision,
        ...
        sse_encode_list_bridge_field_update(fields, serializer);
    }
  }
  ...
  void sse_encode_bridge_web_search_provider_capabilities_descriptor(
    ...
    sse_encode_String(self.hostedDialect, serializer);
  ...
  void sse_encode_bridge_workflow_run(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(self.lineageId, serializer);
    sse_encode_String(self.runId, serializer);
    sse_encode_String(self.modeId, serializer);
    sse_encode_u_64(self.graphRevision, serializer);
    sse_encode_String(self.graphHash, serializer);
    sse_encode_bridge_workflow_run_lifecycle(self.lifecycle, serializer);
    sse_encode_String(self.currentStateId, serializer);
    sse_encode_i_64(self.startedAt, serializer);
    sse_encode_i_64(self.updatedAt, serializer);
  }
  ...
  void sse_encode_bridge_workflow_runtime_snapshot(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_u_64(self.revision, serializer);
    sse_encode_opt_box_autoadd_bridge_workflow_run(self.currentRun, serializer);
  }
  ...
  void sse_encode_list_bridge_agent_profile_dto(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_bridge_agent_profile_dto(item, serializer);
    }
  }
  ...
  void sse_encode_list_bridge_chat_item(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_bridge_chat_item(item, serializer);
    }
  }
  ...
  @protected
  void sse_encode_list_bridge_field_update(
    List<BridgeFieldUpdate> self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_bridge_field_update(item, serializer);
    }
  }
  ...
  void sse_encode_list_bridge_model_price_tier(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_bridge_model_price_tier(item, serializer);
    }
  }
  ...
  void sse_encode_list_bridge_purpose_cost_snapshot(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_bridge_purpose_cost_snapshot(item, serializer);
    }
  }
  ...
  void sse_encode_list_bridge_raw_payload(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_bridge_raw_payload(item, serializer);
    }
  }
  ...
  @protected
  void sse_encode_list_bridge_thread_activity_content_part(
    List<BridgeThreadActivityContentPart> self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_bridge_thread_activity_content_part(item, serializer);
    }
  }

  @protected
  void sse_encode_list_bridge_thread_activity_tool_detail(
    List<BridgeThreadActivityToolDetail> self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_bridge_thread_activity_tool_detail(item, serializer);
    }
  }

  @protected
  void sse_encode_list_bridge_thread_activity_tool_entry(
    List<BridgeThreadActivityToolEntry> self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_bridge_thread_activity_tool_entry(item, serializer);
    }
  }
  ...
  void sse_encode_list_bridge_thread_mode_descriptor(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_bridge_thread_mode_descriptor(item, serializer);
    }
  }

  @protected
  void sse_encode_list_bridge_thread_persistence_snapshot(
    List<BridgeThreadPersistenceSnapshot> self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_bridge_thread_persistence_snapshot(item, serializer);
    }
  }
  ...
  @protected
  void sse_encode_list_bridge_timeline_item_preview(
    List<BridgeTimelineItemPreview> self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_bridge_timeline_item_preview(item, serializer);
    }
  }
  ...
  void sse_encode_list_bridge_timeline_turn(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_bridge_timeline_turn(item, serializer);
    }
  }
  ...
  void sse_encode_list_bridge_view_change(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_bridge_view_change(item, serializer);
    }
  }
  ...
  void sse_encode_list_timeline_items_request(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(self.threadId, serializer);
    sse_encode_bridge_timeline_query(self.query, serializer);
    sse_encode_u_32(self.limit, serializer);
  }
  ...
  void sse_encode_opt_box_autoadd_bridge_chat_item(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_bridge_chat_item(self, serializer);
    }
  }
  ...
  void sse_encode_opt_box_autoadd_bridge_chat_update(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_bridge_chat_update(self, serializer);
    }
  }
  ...
  void sse_encode_opt_box_autoadd_bridge_state_error(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_bridge_state_error(self, serializer);
    }
  }
  ...
  @protected
  void sse_encode_opt_box_autoadd_bridge_thread_activity(
    BridgeThreadActivity? self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_bridge_thread_activity(self, serializer);
    }
  }

  @protected
  void sse_encode_opt_box_autoadd_bridge_thread_activity_tool_entry(
    BridgeThreadActivityToolEntry? self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_bridge_thread_activity_tool_entry(
        self,
        serializer,
      );
    }
  ...
  @protected
  void sse_encode_opt_box_autoadd_bridge_thread_storage_state(
    BridgeThreadStorageState? self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_bridge_thread_storage_state(self, serializer);
    }
  }
  ...
  void sse_encode_opt_box_autoadd_bridge_workflow_run(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_bridge_workflow_run(self, serializer);
    }
  }
  ...
  @protected
  void sse_encode_opt_box_bridge_thread_activity(
    BridgeThreadActivity? self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_bridge_thread_activity(self, serializer);
    }
  }

  @protected
  void sse_encode_opt_box_bridge_thread_storage_state(
    BridgeThreadStorageState? self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_bridge_thread_storage_state(self, serializer);
    }
  }
  ...
  void sse_encode_project_dto(ProjectDto self, SseSerializer serializer) {
    ...
    sse_encode_String(self.name, serializer);
    sse_encode_String(self.path, serializer);
    sse_encode_opt_String(self.sshAlias, serializer);
    sse_encode_i_64(self.updatedAt, serializer);
  }
...
@sealed
class BridgeChatViewImpl extends RustOpaque implements BridgeChatView {
  // Not to be used by end users
  BridgeChatViewImpl.frbInternalDcoDecode(List<dynamic> wire)
    : super.frbInternalDcoDecode(wire, _kStaticData);

  // Not to be used by end users
  BridgeChatViewImpl.frbInternalSseDecode(BigInt ptr, int externalSizeOnNative)
    : super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);

  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount:
        RustLib.instance.api.rust_arc_increment_strong_count_BridgeChatView,
    rustArcDecrementStrongCount:
        RustLib.instance.api.rust_arc_decrement_strong_count_BridgeChatView,
    rustArcDecrementStrongCountPtr:
        RustLib.instance.api.rust_arc_decrement_strong_count_BridgeChatViewPtr,
  );

  /// 结束这个窗口：取消锁内的帧等待、打断正在 await history 的翻页/换焦点。
  Future<void> close() => RustLib.instance.api
      .crateApiStudioHandlersChatBridgeChatViewClose(that: this);
  ...
  Future<BridgeChatSnapshot> expand({required String itemId}) =>
      RustLib.instance.api.crateApiStudioHandlersChatBridgeChatViewExpand(
        that: this,
        itemId: itemId,
      );
  ...
  Future<BridgeChatSnapshot> focus({required BridgeChatFocus focus}) => RustLib
      .instance
      .api
      .crateApiStudioHandlersChatBridgeChatViewFocus(that: this, focus: focus);

  /// The subscription baseline is captured before returning the handle.
  Future<BridgeChatSnapshot> initial() => RustLib.instance.api
      .crateApiStudioHandlersChatBridgeChatViewInitial(that: this);
  ...
  Future<BridgeChatSnapshot> load({required BridgeChatDirection direction}) =>
      RustLib.instance.api.crateApiStudioHandlersChatBridgeChatViewLoad(
        that: this,
        direction: direction,
      );
  ...
  Future<BridgeChatUpdate?> next() => RustLib.instance.api
      .crateApiStudioHandlersChatBridgeChatViewNext(that: this);
  ...
  Future<BridgeChatItem?> readItem({required String itemId}) =>
      RustLib.instance.api.crateApiStudioHandlersChatBridgeChatViewReadItem(
        that: this,
        itemId: itemId,
      );

  /// 当前窗口，并把订阅基线对齐到它：返回的快照版本一定等于随后差量的 `from`。
  Future<BridgeChatSnapshot> snapshot() => RustLib.instance.api
      .crateApiStudioHandlersChatBridgeChatViewSnapshot(that: this);
}
...
class BridgeEventSubscriptionImpl extends RustOpaque
  ...
  Stream<BridgeShutdownProgress> shutdownStream() => RustLib.instance.api
      .crateApiStudioSubscriptionBridgeEventSubscriptionShutdownStream(
        that: this,
      );
