mod config;
mod tools;
pub use config::{SkillsConfig, SystemSkillsConfig};
pub use tools::*;
...
pub use catalog::build_skill_suggestions_from_catalog;
pub use catalog::{
...
pub fn project_skills_dir(workspace_root: &Path, config: &SkillsConfig) -> Result<PathBuf> {
    ...
    crate::workspace::ToolPathPolicy::new(workspace_root.to_path_buf(), false, "skills")?
