...
mod tests {
    use super::*;
    use crate::trace::{TraceDelta, TracePartDeltaEvent, TraceTextChannel};
    ...
    fn start_text(item: &str) -> TraceEventDraft {
        TraceEventDraft::start(
            ...
            "turn".to_owned(),
            item.to_owned(),
            crate::trace::TracePartSource::Model,
            crate::trace::TracePartState::Text(crate::trace::TraceTextPart::streaming(
    ...
    fn concurrent_appends_and_terminal_use_one_revision_owner() {
        ...
        let terminal = sink
            .emit(TraceEventDraft::apply(
                ...
                "turn".to_owned(),
                "text".to_owned(),
                TracePartAction::Complete(crate::trace::TracePartCompletion::Text {
