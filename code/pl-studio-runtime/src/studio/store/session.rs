use crate::{Message, ModelContextItem};
use anyhow::Result;
...
use crate::{AgentSession, InstructionSnapshot, StudioMode};
...
impl StudioStore {
    ...
    pub async fn load_core_session(&self, session_id: &str) -> Result<AgentSession> {
        Ok(AgentSession::from_items(
