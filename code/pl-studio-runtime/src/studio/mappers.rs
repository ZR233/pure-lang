...
fn budget_limit_kind_from_label(label: &str) -> Option<crate::BudgetLimitKind> {
    match label {
        "modelStep" => Some(crate::BudgetLimitKind::ModelStep),
        "toolCall" => Some(crate::BudgetLimitKind::ToolCall),
        "wait" => Some(crate::BudgetLimitKind::Wait),
        "wallClock" => Some(crate::BudgetLimitKind::WallClock),
        "agentCount" => Some(crate::BudgetLimitKind::AgentCount),
        "agentDepth" => Some(crate::BudgetLimitKind::AgentDepth),
        "finalization" => Some(crate::BudgetLimitKind::Finalization),
        _ => None,
    }
}
