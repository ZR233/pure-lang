...
#[cfg(feature = "embedded-remote-helpers")]
pub(crate) fn ssh_manager() -> SshManager {
    SshManager::with_helper_assets(Arc::new(BundledRemoteHelpers::default()))
}

#[cfg(not(feature = "embedded-remote-helpers"))]
pub(crate) fn ssh_manager() -> pl_tool::remote::SshManager {
    pl_tool::remote::SshManager::new(None, None)
}
...
pub(crate) async fn local_worker() -> crate::Result<LocalWorkerAsset> {
