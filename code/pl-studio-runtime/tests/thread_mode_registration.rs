...
use pl_studio_runtime::mode::{
    ThreadModeManager, ThreadModeRegistration, ThreadModeSource, ThreadModeSourceId,
};

#[test]
fn upstream_crate_registers_an_owned_mode_through_studio() {
