...
当前 members：`pl-protocol`、`pl-trace`、`pl-model`、`pl-lsp`、`pl-core`、`pure-studio/rust`

注意：`code/pure-studio/rust` 在 README 中写作 `pl-studio-bridge`。
...
```
pl-protocol  ←  pl-model  ←  pl-core  ←  pl-studio-bridge  ←  pure-studio
                pl-lsp     ←  pl-core
```
