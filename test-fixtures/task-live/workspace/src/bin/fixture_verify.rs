use task_live_fixture::normalize::{NormalizeError, normalize_key};
use task_live_fixture::validate::{ValidationError, validate_key};
...
fn main() {
    ...
    println!("PURE_TASK_FIXTURE_VERIFY_OK");
}
